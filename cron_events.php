...
// «صفرُ عطلٍ حيٍّ في مؤشراتِ الاستهلاك — وإنذارُ توقفٍ يغطيها مجرَّبٌ بإيقافٍ
// مقصود» (شرطُ الاكتمالِ ١٣). ويُنادى **بعدَ** `runOnce()` لا قبلَه: فالدورةُ
// الناجحةُ تحرّك المؤشرَ وتُسقط الإنذارَ عن نفسِها، والنداءُ قبلَها يُنذر عن
// تأخُّرٍ سيزول بعدَ سطر. وموضعُه هنا لأن `$dispatcher` وحدَه يعرف مَن سُجِّل
// له معالجٌ — فاليتيمُ لا يُكشف من خارجِ الموزّع.
$stalled = $dispatcher->alertStalledConsumers();
if ($stalled > 0) {
