...
<div class="main">
    ...
    <div class="page-header">
        <div style="display: flex; align-items: center; gap: 12px;">
            ...
            <h1 class="page-title">ØªÙØ§ØµÙŠÙ„ Ø¹Ù‚Ø¯ Ø§Ù„Ù…ÙˆØ±Ø¯</h1>
        </div>
    ...
    <div class="card">
        <div class="card-header">
            <h5><i class="fas fa-cogs"></i> Ø¥Ø¬Ø±Ø§Ø¡Ø§Øª Ø§Ù„Ø¹Ù‚Ø¯</h5>
        </div>
        <div class="card-body">
            <div class="action-bar">
                <button class="add-btn" id="renewalBtn" title="ØªØ¬Ø¯ÙŠØ¯ Ù…Ø¯Ø© Ø§Ù„Ø¹Ù‚Ø¯" style="background: linear-gradient(135deg, #17a2b8 0%, #138496 100%);">
                    <i class="fas fa-sync-alt"></i> ØªØ¬Ø¯ÙŠØ¯ Ø§Ù„Ø¹Ù‚Ø¯
                </button>
                <button class="add-btn" id="settlementBtn" title="ØªØ³ÙˆÙŠØ© Ø§Ù„Ø³Ø§Ø¹Ø§Øª Ø§Ù„Ù…ØªØ¨Ù‚ÙŠØ©" style="background: linear-gradient(135deg, #6c757d 0%, #545b62 100%);">
                    <i class="fas fa-balance-scale"></i> ØªØ³ÙˆÙŠØ©
                </button>
                <button class="add-btn" id="pauseBtn" title="Ø¥ÙŠÙ‚Ø§Ù Ù…Ø¤Ù‚Øª Ù„Ù„Ø¹Ù‚Ø¯" style="background: linear-gradient(135deg, #ffc107 0%, #e0a800 100%);">
                    <i class="fas fa-pause-circle"></i> Ø¥ÙŠÙ‚Ø§Ù
                </button>
                <button class="add-btn" id="resumeBtn" title="Ø§Ø³ØªØ¦Ù†Ø§Ù Ø§Ù„Ø¹Ù‚Ø¯ Ø§Ù„Ù…ØªÙˆÙ‚Ù" style="background: linear-gradient(135deg, #28a745 0%, #218838 100%);">
                    <i class="fas fa-play-circle"></i> Ø§Ø³ØªØ¦Ù†Ø§Ù
                </button>
                <button class="add-btn" id="terminateBtn" title="Ø¥Ù†Ù‡Ø§Ø¡ Ø§Ù„Ø¹Ù‚Ø¯" style="background: linear-gradient(135deg, #dc3545 0%, #c82333 100%);">
                    <i class="fas fa-times-circle"></i> Ø¥Ù†Ù‡Ø§Ø¡
                </button>
                <button class="add-btn" id="mergeBtn" title="Ø¯Ù…Ø¬ Ù‡Ø°Ø§ Ø§Ù„Ø¹Ù‚Ø¯ Ù…Ø¹ Ø¹Ù‚Ø¯ Ø¢Ø®Ø±" style="background: linear-gradient(135deg, #e83e8c 0%, #d63384 100%);">
                    <i class="fas fa-object-group"></i> Ø¯Ù…Ø¬
                </button>
                <button class="add-btn" id="completeBtn" title="ØªØ³Ø¬ÙŠÙ„ Ø§Ù†ØªÙ‡Ø§Ø¡ Ø§Ù„Ø¹Ù‚Ø¯" style="background: linear-gradient(135deg, #6f42c1 0%, #5a32a3 100%);">
