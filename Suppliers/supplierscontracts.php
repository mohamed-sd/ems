...
require_once __DIR__ . '/../includes/w14_grid.php'; // شبكةُ حقولِ الورقة
...
<div class="main contracts-main supplier-contracts-page ems-unified-page-shell">
  ...
  include('../includes/page_header.php'); ?>
    ...
    <div class="card"><div class="card-header"><h5><i class="fa fa-clipboard-list"></i> سجل عقود الموردين بحقول الورقة</h5></div>
    <div class="card-body"><div class="table-container">
        ...
        $GUIDE_COLS = array(
            'كود عقد المورد' => 'c107',
            'التسلسل الزمني للعقد' => 'c108',
            'رقم المورد' => 'c109',
            'اسم المورد (بحث)' => 'c110',
            'كود العقد (العميل)' => 'c111',
            'رقم العميل' => 'c112',
            'اسم العميل (بحث)' => 'c113',
            'نموذج العمل' => 'c114',
            'رقم عقد المورد (رتبة الانضمام)' => 'c115',
            'تسلسل عقد المورد بالشركة' => 'c116',
            'مفتاح دورة الالتزام' => 'c117',
            'استثناء تسوية فقط؟' => 'c118',
            'مرجع اعتماد الاستثناء' => 'c119',
            'توقيع الوثيقة' => 'c120',
            'البداية التعاقدية (مستنتجة)' => 'c121',
            'النهاية التعاقدية (مستنتجة)' => 'c122',
            'أساس استنتاج المدة' => 'c123',
            'البداية التنفيذية' => 'c124',
            'النهاية التنفيذية' => 'c125',
            'تاريخ الانضمام (أول يوم عمل)' => 'c126',
            'حالة العقد' => 'c127',
            'أساس حالة العقد' => 'c128',
            'تعارض مع حالة عقد العميل' => 'c129',
            'تكييف الوثيقة' => 'c130',
            'مستوى الحجية' => 'c131',
            'العملة' => 'c132',
            'شروط السداد' => 'c133',
            'موقع التنفيذ/المنجم' => 'c134',
            'القيمة الشهرية التعاقدية' => 'c135',
            'قيمة العقد التقديرية' => 'c136',
            'عدد البنود' => 'c137',
            'عدد الوحدات التعاقدية المسندة' => 'c138',
            'نسخة العقد الحالية' => 'c139',
            'مرجع آخر ملحق (م21)' => 'c140',
            'حالة الإغلاق' => 'c141',
            'علم انتهاء قبل عقد العميل' => 'c142',
            'حلقات الحجية المتوفرة (من 20)' => 'c143',
            'نسبة اكتمال الملف المستندي' => 'c144',
            'الحلقات المفقودة' => 'c145',
            'حالة البيانات' => 'c146',
            'ملاحظات' => 'c147',
            'المنشئ' => 'c148',
            'المراجع' => 'c149',
            'المعتمد' => 'c150',
            'تاريخ الاعتماد الداخلي' => 'c151',
        );
        $D = array();
        $__gridRows = ems_w14_guide_rows('sup_contract_register');
        echo ems_w14_grid('emsList_sup_contracts', $GUIDE_COLS, $__gridRows, $D, 'لا عقد مورد مسجل بعد'); /* /GUIDE_COLS */ ?>
    </div></div></div>
    <?php 
