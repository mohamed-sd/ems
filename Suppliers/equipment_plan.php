...
include __DIR__ . '/../includes/page_header.php'; ?>
    ...
    <div class="card"><div class="card-header"><h5><i class="fa fa-clipboard-list"></i> معدات المورد المتاحة بحقول الورقة</h5></div>
    <div class="card-body"><div class="table-container">
        ...
        $GUIDE_COLS = array(
            'كود المعدة' => 'c46',
            'التسلسل الزمني للإسناد' => 'c47',
            'رقم المورد' => 'c48',
            'اسم المورد (بحث)' => 'c49',
            'نوع الآلية/البند' => 'c50',
            'بادئة النوع (v4)' => 'c51',
            'رقم اللوحة (كما ورد)' => 'c52',
            'رمز اللوحة' => 'c53',
            'رقم اللوحة (رقمي)' => 'c54',
            'رقم الشاسي' => 'c55',
            'سنة الصنع' => 'c56',
            'الملكية' => 'c57',
            'المالك القانوني للمعدة' => 'c58',
            'هاتف المالك' => 'c59',
            'صفة المورد تجاه المعدة' => 'c60',
            'مستند حق التقديم (نوع/رقم/تاريخ/جهة)' => 'c61',
            'حالة التحقق من الصفة' => 'c62',
            'تاريخ التحقق' => 'c63',
            'المتحقق' => 'c64',
            'مخاطر الصفة' => 'c65',
            'وسم «لا ترسمل»' => 'c66',
            ...
            'تاريخ أول إسناد' => 'c68',
            'تاريخ آخر إسناد' => 'c69',
            'أشهر منذ آخر نشاط' => 'c70',
            'عدد الوحدات التعاقدية التي خدمها' => 'c71',
            'آخر عميل خدمه' => 'c72',
            'أساس حالة المعدة' => 'c73',
            'علم تعارض الحالة' => 'c74',
            'تاريخ الحالة' => 'c75',
            'معدة مساندة؟' => 'c76',
            'مرادفات أكواد قديمة' => 'c77',
            'مصدر التوثيق' => 'c78',
            'ملاحظات' => 'c79',
        );
        $D = array();
        $__gridRows = ems_w14_guide_rows('sup_equipment_available');
        echo ems_w14_grid('emsList_sup_equipplan', $GUIDE_COLS, $__gridRows, $D, 'لا معدة متاحة مسجلة بعد'); /* /GUIDE_COLS */ ?>
    </div></div></div>
    <?php 
