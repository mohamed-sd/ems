...
$sql = "SELECT 
            sc.id, sc.driver_id, sc.project_id, sc.mine_id, sc.project_contract_id, sc.contract_signing_date, sc.grace_period_days, sc.contract_duration_months, sc.contract_duration_days,
...
?>
    ...
    <div style="text-align: center; margin: 2rem 0;">
        <a href="drivers.php" class="btn btn-lg" style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); color: white; border: none; padding: 1rem 3rem; border-radius: 15px; font-weight: 700; box-shadow: 0 4px 15px rgba(102, 126, 234, 0.3);">
...
function performAction(action, data = {}) {
    $.ajax({
        url: 'driver_contract_actions_handler.php',
        type: 'POST',
