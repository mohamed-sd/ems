<?php
/**
 * 2028_02_10_universe_ruled_bridge.php — مفردةُ مطابقةٍ جديدة: الجسرُ المحكوم (GOV_EXEC §5)
 * ═══════════════════════════════════════════════════════════════════════════
 ...
 * التشغيل: php database/migrations/2028_02_10_universe_ruled_bridge.php
 * ═══════════════════════════════════════════════════════════════════════════
 */
...
$ok = $conn->query("ALTER TABLE repair01_target_universe
    MODIFY match_method ENUM('EXACT_UNIT','EXACT_ANY','COMPOUND_SPLIT','CONTAINMENT_CANDIDATE','WAVE_ANCHOR','RULED_BRIDGE','NONE')
        NOT NULL DEFAULT 'NONE'
        COMMENT 'طريق المطابقة — RULED_BRIDGE: جسر وظيفة محكوم بدليله (شاشة حية تخدم الهدف باسم اخر)'");
