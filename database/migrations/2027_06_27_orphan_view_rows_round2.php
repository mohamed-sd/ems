<?php
/**
 * 2027_06_27_orphan_view_rows_round2.php
 * ═══════════════════════════════════════════════════════════════════════════
 * ◆ إصلاحُ كسرٍ صنعتْه هذه الحملةُ نفسُها — بشهادةِ المراجعةِ العكسية:
 *   إعادةُ تفعيلِ الروابطِ اليتيمةِ (هجرة 2027_06_20) أظهرت خمسَ شاشاتٍ باقيةً (الفاحصُ يعرض 12 فقط في المرة)
...
$DECLARE = array(
    array('Contracts/client_statement.php',      'المالية والخزينة'),
    array('Transport/transfer_tariffs.php',      'إدارة الموردين'),
    array('admin/org_structure.php',             'إدارة التشغيل'),
    array('admin/org_assignments.php',           'إدارة الموقع'),
    array('Equipments/equipments_types.php',     'إدارة الموردين'),
);
