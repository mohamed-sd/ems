 ...
 *
 * ⚠ **نُقض قرارُ الظهورِ في 2026-08-21** — أمرَ المالكُ بإخفاءِ الرابطِ من سايدبارِ
 *   إدارةِ الموردين، فأطفأت `2027_08_18_equipments_hidden_from_suppliers_space.php`
 *   القفلَين ③ و④ (`nav_items.active=0` و`cls='FORBIDDEN'`) **وتركت ① و② كما هما**:
 *   الصلاحيةُ باقيةٌ والرابطُ مخفيّ. فما تقرؤه أدناه **تاريخُ المنحِ لا الحالةَ الجارية**،
 *   وبرهانُ `tests/equipments_suppliers_mgr_http_proof.php` يحرس الحالةَ الجديدةَ لا هذه.
 *   ولإعادةِ الظهورِ: `php database/migrations/2027_08_18_… --revert`.
 *
