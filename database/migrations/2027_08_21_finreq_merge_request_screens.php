 ...
 *   ⑤ **التصنيفُ والتحويل**: `nav_route_group` يبقى `FINANCE` — الشاشةُ الموحَّدةُ
 *      **في مكانِ القديمةِ نفسِه** بقرارِ المالك («أظهِر الجديدةَ في نفسِ الأماكنِ
 *      التي كانت فيها القديمة»)، و`nav_redirects` يُسجَّل فيه المتقاعدُ بعدّاد.
 *
...
/* الشاشةُ الموحَّدةُ تبقى في مجموعتِها — «أظهِر الجديدةَ في نفسِ أماكنِ القديمة»
   (قرارُ المالك 2026-08-21). ولا يُصنع لها موضعٌ ثالث: `uxuiNavBaseRoute` يجرّد
   المرساةَ والمعامل، فالمسارُ الواحدُ مجموعةٌ واحدةٌ في كلِّ الأدوارِ سواء. */
$GROUP_NEW = 'FINANCE';
