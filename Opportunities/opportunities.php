        ...
        <div class="card shadow-sm pu-form-card">
            <div class="card-body">
                ...
                <div class="pu-form-actions">
                    <button type="submit" class="btn-primary"><i class="fas fa-save"></i> <span id="submitBtnText">حفظ الفرصة</span></button>
                    <button type="button" id="oppFormCancelBtn" class="btn-secondary"><i class="fas fa-times"></i> إلغاء</button>
                </div>
            </div>
        </div>
    </form>
