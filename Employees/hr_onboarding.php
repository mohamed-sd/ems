...
<div class="main ems-unified-page-shell">
    ...
    echo ems_w14_grid('emsList_hr_onboarding', $GUIDE_COLS, $__gridRows, $D, 'لا سطر مسجل بعد في التهيئة والمباشرة'); /* /GUIDE_COLS */ ?>
    ...
    ems_w14_guide_form(array(
        'surfaces' => array('التهيئه والمباشره', 'التهيئة والمباشرة'),
        'table'    => 'hr_onboarding',
        'cols'     => $GUIDE_COLS,
        'screen'   => 'Employees/hr_onboarding.php',
    )); ?>
</div>
</div>
</body></html>
