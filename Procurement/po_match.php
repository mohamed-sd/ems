...
/* ── RPR-W02 §٤-٤ · CS-01 · RF-02 — الحارسُ فوقَ المعالجِ لا تحتَه ──────────
   كان `INSERT INTO exec_approvals` في السطرِ 130 و`insidebar` (منفِّذُ حارسِ
   العرض) في السطرِ 245 — فالأثرُ يُرحَّل ثمَّ يُقال «لا صلاحية». والمسارُ
   المباشرُ يُفتح فيكتب قبلَ أن يُسأل. الدالةُ نفسُها والتغييرُ في **متى**. */
