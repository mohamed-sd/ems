...
if (function_exists('ems_states_bundle')) {
    echo ems_states_bundle('لا بياناتِ حوكمةٍ للمشتريات ضمن النطاق الحالي',
                           'تُقاس اللوحةُ من حساباتِ المشتريات وصلاحياتِ شاشاتِها وسجلاتِ تدقيقِها — راجعِ النطاقَ أو الفترة');
}
