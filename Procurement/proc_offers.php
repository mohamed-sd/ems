...
<div class="main ems-unified-page-shell">
    ...
    <div class="table-wrap"><table class="data-table">
        ...
        <?php if ($rows): foreach ($rows as $r): $q = isset($rfqs[(int) $r['rfq_id']]) ? $rfqs[(int) $r['rfq_id']] : null; ?>
            ...
            <?= ems_sf_cells($r, array('offer_uid', 'rfq_no', 'supplier_no', 'supplier_name', 'receipt_date', 'offer_value', 'offered_payment_terms', 'offer_validity', 'technical_evaluation', 'inspection_notes', 'financial_arrangement', 'offer_state', 'creator_name', 'created_date', 'data_state', 'source_ref', 'line_uid', 'request_item_ref', 'item_code', 'offered_unit_price', 'quantity', 'item_lead_time', 'alternative_proposed', 'technical_note', 'item_financial_ranking')) ?></tr>
