<?php
/**
 * Procurement/gov_dept_inv.php — حوكمة المخازن
 * ─────────────────────────────────────────────────────────────────────────
 * ظهورٌ نطاقيٌّ لمكوّن «حوكمة الإدارة» الواحد على المخازن:
 ...
 * يمنح، ونطاقُه `gov_dept_inv` يُطابَق على سجلِّ الشاشاتِ في المعالج.
 *
 * ◆ عدّادُ الأحداثِ مقصورٌ على `source_module = 'warehouse'` — فما ظهر صفرًا
...
$__pp = check_page_permissions($conn, 'Procurement/gov_dept_inv.php');
...
$GOV_DEPT = array(
    ...
    'team_roles'      => array(25),
    'sensitive_like'  => 'stock%',
    'events_module'   => 'warehouse',
    'attest_endpoint' => '../Governance/gov_m14_actions.php',
    'attest_code'     => 'gov.inv.attest',
    'attest_scope'    => 'gov_dept_inv',
...
if (function_exists('ems_states_bundle')) {
    echo ems_states_bundle('لا بياناتِ حوكمةٍ للمخازن ضمن النطاق الحالي',
                           'تُقاس اللوحةُ من حساباتِ المخازن وصلاحياتِ شاشاتِها وسجلاتِ تدقيقِها — راجعِ النطاقَ أو الفترة');
}
