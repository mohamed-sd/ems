 ...
 *
 * [مُستثنى بنيويًا — تمهيدٌ سابقٌ لكل هوية · هـ-2] هذا هو ملف التمهيد الجذري الذي
 * يُنشئ أوّل مدير أعلى قبل وجود أيّ جلسةٍ من أيّ نوع؛ فلا بوابةَ يمكنها خدمته (لا سياق
 * ولا مصادَقًا عليه بعد). معطَّلٌ افتراضيًا (403 · $ENABLE_SETUP_SCRIPT=false) ويعمل من
 * localhost حصرًا — تبقى نداءاته خامًا بحكم طبيعته التمهيدية.
 */
