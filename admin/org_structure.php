...
$layerTitles = array(
    ...
    'oversight' => '③ المجالان الرقابيان — يمنحان ويرصدان ولا ينفذان',
);
...
<div class="main ems-unified-page-shell">
    ...
    ems_screen_about(
        ...
        . 'ثمان تشغيلية تحت مدير التشغيل (ومنها الموارد البشرية إداريا باستقلال فني تام)، '
        . 'وأربع موازية تحت المدير التنفيذي، ومجالان رقابيان. '
        . 'رأس كل وحدة يشتق من التكليف النافذ ولا يكتب.',
        array('الرأس «بلا تكليف نافذ» يعني وحدة بلا مكلف حي — أنشئ تكليفا من شاشة التكليفات',
              'الموارد البشرية: لا يعتمد مدير التشغيل تعيينا ولا أجرا ولا جزاء (DEC-ORG-A)'));

    /* UXW-01 ⑨: حزمةُ الحالاتِ الدنيا — مخفيةٌ افتراضًا ويُظهرها منطقُ الشاشةِ عند حالِها */
    echo ems_states_bundle('لا وحدات هيكل نشطة لهذه الشركة',
        'وحدات الهيكل تبذر من مصفوفة ORG-01 §1.1 — راجع مدير الصلاحيات');
    ?>
