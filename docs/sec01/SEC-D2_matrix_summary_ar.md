# SEC-D2 · مصفوفة الشاشات والأفعال (218 × 25) — مسودة التحويل

> CSV كامل: `SEC-D2_matrix_208x25.csv` — صف لكل (دور × موديول) = 5450 صفًّا، منها **1068** بمنح قائم (role_permissions=1008 بالرايات الأربع).
