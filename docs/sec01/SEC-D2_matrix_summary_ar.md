# SEC-D2 · مصفوفة الشاشات والأفعال (433 × 35) — مسودة التحويل

> CSV كامل: `SEC-D2_matrix_208x25.csv` — صف لكل (دور × موديول) = 15155 صفًّا، منها **2446** بمنح قائم (role_permissions=1008 بالرايات الأربع).
