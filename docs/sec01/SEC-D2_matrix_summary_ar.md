# SEC-D2 · مصفوفة الشاشات والأفعال (432 × 35) — مسودة التحويل

> CSV كامل: `SEC-D2_matrix_208x25.csv` — صف لكل (دور × موديول) = 15120 صفًّا، منها **2444** بمنح قائم (role_permissions=1008 بالرايات الأربع).
