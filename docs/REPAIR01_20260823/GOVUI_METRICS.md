...
> مولَّدةٌ حيًّا بـ`tools/govui_metrics.php` · اللقطة **BL-20260901-595c7b3e** · 2026-09-01 19:33
...
| `FIELD_CONFORMANCE` | **2570/5460** | AUDIT إلحاقيّةٌ خارجَ المقام 993 حقلًا (§7·11) · المقيسُ 362 سطحًا مطابَقًا | `rpr02_field_measure (الدفترُ مُسوًّى على الحزمةِ الجديدة)` |
| `GRAIN_CONFORMANCE` | **375/413** | يجمع حبّتَين 6 · بلا حبّةٍ مقيسةٍ 32 · وغيرُ المبنيِّ خارجَ المقام | `govui_target_registry × rpr02_grain_measure` |
