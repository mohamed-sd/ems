...
> مولَّدةٌ حيًّا بـ`tools/govui_metrics.php` · اللقطة **BL-20260901-62521226** · 2026-09-01 16:39
...
| `STATE_MODEL_CONFORMANCE` | **127/210** | المقامُ أسطحُ المعاملاتِ الحقيقيّةُ وحدها (حبّةٌ سطرٌ/بندٌ وحقيقةٌ مملوكة) · والباقي بلا آلةٍ مؤلَّفةٍ — والتأليفُ حكمُ أعمالٍ لا قياس | `rpr02_state_model_bind (المدى نفسُه)` |
