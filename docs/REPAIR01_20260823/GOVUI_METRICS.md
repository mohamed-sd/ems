...
> مولَّدةٌ حيًّا بـ`tools/govui_metrics.php` · اللقطة **BL-20260902-b0795c42** · 2026-09-02 00:50
...
| `FIELD_CONFORMANCE` | **5470/5470** | AUDIT إلحاقيّةٌ خارجَ المقام 997 حقلًا (§7·11) · المقيسُ 363 سطحًا مطابَقًا | `rpr02_field_measure (الدفترُ مُسوًّ⇐ docs/REPAIR01_20260823/GOVUI_METRICS.md
| `GRAIN_CONFORMANCE` | **413/413** | يجمع حبّتَين 0 · بلا حبّةٍ مقيسةٍ 0 · وغيرُ المبنيِّ خارجَ المقام | `govui_target_registry × rpr02_grain_measure` |
| `STATE_MODEL_CONFORMANCE` | **271/392** | المقامُ أسطحُ المعاملاتِ الحقيقيّةُ وحدها (حبّةٌ سطرٌ/بندٌ وحقيقةٌ مملوكة) · والباقي بلا آلةٍ مؤلَّفةٍ — والتأليفُ حكمُ أعمالٍ لا قياس | `rpr02_state_model_bind (المدى نفسُه)` |
