...
> مولَّدةٌ حيًّا بـ`tools/govui_metrics.php` · اللقطة **BL-20260901-7fc622c2** · 2026-09-01 09:37
...
| `FIELD_CONFORMANCE` | **5470/5470** | AUDIT إلحاقيّةٌ خارجَ المقام 997 حقلًا (§7·11) · المقيسُ 363 سطحًا مطابَقًا | `rpr02_field_measure (الدفترُ مُسوًّى على الحزمةِ الجديدة)` |
