...
> مولَّدةٌ حيًّا بـ`tools/govui_metrics.php` · اللقطة **BL-20260901-29c6e493** · 2026-09-01 10:10
...
| `FIELD_CONFORMANCE` | **5512/5547** | AUDIT إلحاقيّةٌ خارجَ المقام 1007 حقلًا (§7·11) · المقيسُ 367 سطحًا مطابَقًا | `rpr02_field_measure (الدفترُ مُسوًّى على الحزمةِ الجديدة)` |
