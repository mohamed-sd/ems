...
> مولَّدٌ حيًّا من `01 · الدليل المعماري` و`02 · القيادة` بـ`tools/govui_target_registry.php` · اللقطة **BL-20260901-efb30839**
...
|---|---|---|---|---|---|
| `NT-DEP-01-001` | DEP-01 | `MENU_ITEM` | سجل العملاء | المرحلة التمهيدية | `clients/clients.php` |
| `NT-DEP-01-002` | DEP-01 | `TAB_CHILD` | جهات اتصال العملاء | المرحلة التمهيدية | `clients/client_contacts.php` |
| `NT-DEP-01-003` | DEP-01 | `MENU_ITEM` | سجل المشاريع | المرحلة التمهيدية | `projects/projects.php` |
| `NT-DEP-01-004` | DEP-01 | `MENU_ITEM` | الفرص البيعية | خط الأنابيب | `opportunities/opportunities.php` |
| `NT-DEP-01-005` | DEP-01 | `MENU_ITEM` | الأنشطة والمتابعات | خط الأنابيب | `contracts/sales_activities.php` |
| `NT-DEP-01-006` | DEP-01 | `MENU_ITEM` | احتياج العميل وطلب العرض | خط الأنابيب | `opportunities/client_need_rfq.php` |
...
| `NT-DEP-02-011` | DEP-02 | `MENU_ITEM` | الوحدات المكافئة وتخصيص الحصص | التشغيل | `suppliers/supplier_quota_distribution.php` |
| `NT-DEP-02-012` | DEP-02 | `MENU_ITEM` | حصص الموردين والوحدات التعاقدية | التشغيل | `suppliers/supplier_contract_units.php` |
| `NT-DEP-02-013` | DEP-02 | `MENU_ITEM` | سجل الإشغال والتسليم | التشغيل | `suppliers/supplier_slot_handover.php` |
| `NT-DEP-02-014` | DEP-02 | `MENU_ITEM` | توزيع الوحدات التعاقدية على المعدات | التشغيل | `suppliers/supplier_unit_equipment.php` |
| `NT-DEP-02-015` | DEP-02 | `MENU_ITEM` | الجاهزية والإحلال والاحتياط | التشغيل | `suppliers/supplier_readiness_reserve.php` |
| `NT-DEP-02-016` | DEP-02 | `MENU_ITEM` | مستهدفات الموردين | التشغيل | `suppliers/supplier_targets.php` |
| `NT-DEP-02-017` | DEP-02 | `MENU_ITEM` | الأداء والوحدات المعتمدة | التشغيل | `suppliers/supplier_performance_entries.php` |
| `NT-DEP-02-018` | DEP-02 | `MENU_ITEM` | قياس التغطية والعجز والفائض | التشغيل | `Suppliers/shares_coverage.php` |
...
| `NT-DEP-02-031` | DEP-02 | `MENU_ITEM` | سجل المستندات والضمانات | المرجعيات | `suppliers/supplier_docs_guarantees.php` |
...
| `NT-DEP-03-004` | DEP-03 | `MENU_ITEM` | فرص واحتياجات التمويل | الدورة | `financing/fin_needs.php` |
| `NT-DEP-03-005` | DEP-03 | `MENU_ITEM` | عروض التمويل والتفاوض | الدورة | `financing/fin_offers.php` |
| `NT-DEP-03-006` | DEP-03 | `MENU_ITEM` | مراجعة ما قبل التعاقد | الدورة | `financing/fin_precontract_review.php` |
...
| `NT-DEP-03-011` | DEP-03 | `TAB_CHILD` | الأصول الممولة | الأصول | `equipments/fin_assets.php` |
| `NT-DEP-03-012` | DEP-03 | `TAB_CHILD` | حصص الملكية وحق الانتفاع | الأصول | `financing/owners_registry.php` |
...
| `NT-DEP-03-021` | DEP-03 | `MENU_ITEM` | تعديلات التمويل وإعادة الجد | الحوكمة | `financing/fin_changes.php` |
| `NT-DEP-03-022` | DEP-03 | `MENU_ITEM` | الانحرافات والمتأخرات | الحوكمة | `financing/deviations.php` |
| `NT-DEP-03-023` | DEP-03 | `MENU_ITEM` | انتقال الملكية والخروج | الأصول | `financing/asset_disposal.php` |
...
| `NT-DEP-04-001` | DEP-04 | `MENU_ITEM` | مصادر القدرة | أ · التعريف والسياسات | `fleet/power_sources.php` |
| `NT-DEP-04-002` | DEP-04 | `MENU_ITEM` | دليل الترميز والتصنيف | أ · التعريف والسياسات | `fleet/classification_directory.php` |
| `NT-DEP-04-003` | DEP-04 | `MENU_ITEM` | طلب إدخال الأصل | ب · دخول الأصل | `fleet/asset_intake.php` |
| `NT-DEP-04-004` | DEP-04 | `DIRECT_ONLY` | التحقق من المصدر | ب · دخول الأصل | `fleet/asset_intake.php` |
| `NT-DEP-04-005` | DEP-04 | `DIRECT_ONLY` | أمر التفتيش | ب · دخول الأصل | `fleet/asset_intake.php` |
| `NT-DEP-04-006` | DEP-04 | `MENU_ITEM` | بطاقة التفتيش | ب · دخول الأصل | `fleet/inspection_card.php` |
| `NT-DEP-04-007` | DEP-04 | `MENU_ITEM` | كرت الأصل | ب · دخول الأصل | `fleet/asset_card.php` |
| `NT-DEP-04-008` | DEP-04 | `TAB_CHILD` | مستندات الأصل | ب · دخول الأصل | `fleet/asset_documents.php` |
| `NT-DEP-04-009` | DEP-04 | `TAB_CHILD` | حق الاستخدام التشغيلي | ب · دخول الأصل | `fleet/asset_use_rights.php` |
| `NT-DEP-04-010` | DEP-04 | `TAB_CHILD` | المكونات والملحقات | ب · دخول الأصل | `fleet/asset_components.php` |
| `NT-DEP-04-011` | DEP-04 | `DIRECT_ONLY` | التفعيل وإعادة الخدمة | ج · دخول التشغيل | `fleet/asset_intake.php` |
| `NT-DEP-04-012` | DEP-04 | `MENU_ITEM` | التخصيص على الوحدات | ج · دخول التشغيل | `fleet/asset_assignments.php` |
| `NT-DEP-04-013` | DEP-04 | `DIRECT_ONLY` | حركة الموقع والمشروع | د · الحركة والاستخدام | `fleet/asset_assignments.php` |
| `NT-DEP-04-014` | DEP-04 | `MENU_ITEM` | السجل اليومي للتشغيل | د · الحركة والاستخدام | `fleet/daily_operating_log.php` |
| `NT-DEP-04-015` | DEP-04 | `TAB_CHILD` | تاريخ المشغلين على المعدة | د · الحركة والاستخدام | `fleet/asset_full_history.php` |
| `NT-DEP-04-016` | DEP-04 | `MENU_ITEM` | الحالة الفنية | هـ · الرقابة الفنية | `fleet/technical_state.php` |
| `NT-DEP-04-017` | DEP-04 | `MENU_ITEM` | سجل تغير الحالة | هـ · الرقابة الفنية | `fleet/state_change_log.php` |
| `NT-DEP-04-018` | DEP-04 | `MENU_ITEM` | سجل الأعطال والتوقفات | هـ · الرقابة الفنية | `fleet/breakdown_log.php` |
| `NT-DEP-04-019` | DEP-04 | `MENU_ITEM` | الملخص التشغيلي الشهري | هـ · الرقابة الفنية | `fleet/asset_readiness.php` |
| `NT-DEP-04-020` | DEP-04 | `DIRECT_ONLY` | الجاهزية الشهرية | هـ · الرقابة الفنية | `fleet/asset_readiness.php` |
| `NT-DEP-04-021` | DEP-04 | `MENU_ITEM` | الخروج المؤقت | و · الخروج | `fleet/asset_exit.php` |
| `NT-DEP-04-022` | DEP-04 | `DIRECT_ONLY` | الخروج الدائم | و · الخروج | `fleet/asset_exit.php` |
| `NT-DEP-04-023` | DEP-04 | `MENU_ITEM` | سجل الاستثناءات | ز · الاستثناءات والقرارات | `fleet/exception_register.php` |
| `NT-DEP-04-024` | DEP-04 | `MENU_ITEM` | ملاحظات المراجع الخارجي | ز · الاستثناءات والقرارات | `fleet/external_auditor_notes.php` |
| `NT-DEP-04-025` | DEP-04 | `MENU_ITEM` | التضاربات بين المصادر | ز · الاستثناءات والقرارات | `fleet/source_conflicts.php` |
| `NT-DEP-04-026` | DEP-04 | `MENU_ITEM` | النقاط غير المحسومة | ز · الاستثناءات والقرارات | `fleet/open_points.php` |
| `NT-DEP-04-027` | DEP-04 | `MENU_ITEM` | حزمة القرارات الإدارية | ز · الاستثناءات والقرارات | `fleet/management_decisions.php` |
| `NT-DEP-04-028` | DEP-04 | `MENU_ITEM` | تاريخ المعدة الكامل | ح · المخرجات | `fleet/asset_full_history.php` |
| `NT-DEP-04-029` | DEP-04 | `LANDING_PAGE` | لوحة الأسطول | اللوحة — خارج الدورة | `fleet/fleet_board.php` |
| `NT-DEP-04-030` | DEP-04 | `MENU_ITEM` | مرجع ساعات التشغيل للإهلاك | ح · المخرجات | `fleet/asset_hours_reference.php` |
| `NT-DEP-04-031` | DEP-04 | `MENU_ITEM` | مرجع العمر الإنتاجي بالساعات | ط · المرجعيات والمصالحة | `fleet/asset_life_reference.php` |
| `NT-DEP-04-032` | DEP-04 | `MENU_ITEM` | نطاقات حق الاستخدام | ط · المرجعيات والمصالحة | `fleet/use_right_ranges.php` |
| `NT-DEP-04-033` | DEP-04 | `UTILITY` | مصالحة مطابقة الأكواد | ط · المرجعيات والمصالحة | `fleet/code_reconciliation.php` |
| `NT-DEP-04-034` | DEP-04 | `UTILITY` | مصالحة جسر الترقيم | ط · المرجعيات والمصالحة | `fleet/numbering_bridge.php` |
| `NT-DEP-04-035` | DEP-04 | `UTILITY` | مصالحة الأسطول بالملاك | ط · المرجعيات والمصالحة | `fleet/owner_reconciliation.php` |
| `NT-DEP-04-036` | DEP-04 | `MENU_ITEM` | مصالحة السجل بالتشغيل | ط · المرجعيات والمصالحة | `fleet/register_operation_recon.php` |
| `NT-DEP-04-037` | DEP-04 | `UTILITY` | مصالحة الأعيان الممولة | ط · المرجعيات والمصالحة | `fleet/financed_asset_recon.php` |
| `NT-DEP-05-001` | DEP-05 | `LANDING_PAGE` | لوحة المالية | اللوحة — خارج الدورة | `finance/cfo_daily_board_fin.php` |
| `NT-DEP-05-002` | DEP-05 | `MENU_ITEM` | دليل الحسابات | التأسيس المرجعي | `finance/management_accounting_fin.php` |
| `NT-DEP-05-003` | DEP-05 | `MENU_ITEM` | مراكز التكلفة | التأسيس المرجعي | `finance/acc_cost_centers.php` |
| `NT-DEP-05-004` | DEP-05 | `MENU_ITEM` | التقويم المحاسبي للفترات | التأسيس المرجعي | `finance/periods_fin.php` |
| `NT-DEP-05-005` | DEP-05 | `MENU_ITEM` | الميزانية والتقدير | التأسيس المرجعي | `finance/budget_master.php` |
| `NT-DEP-05-006` | DEP-05 | `MENU_ITEM` | أسعار الصرف | التأسيس المرجعي | `finance/currencies_fin.php` |
...
| `NT-DEP-06-013` | DEP-06 | `MENU_ITEM` | المطابقة البنكية | الرقابة والإقفال | `finance/bank_reconciliation_fin.php` |
| `NT-DEP-06-014` | DEP-06 | `MENU_ITEM` | التسهيلات البنكية | الرقابة والإقفال | `finance/tre_facilities.php` |
| `NT-DEP-06-015` | DEP-06 | `MENU_ITEM` | خطابات الضمان والاعتمادات المستندية | الرقابة والإقفال | `finance/tre_guarantees.php` |
| `NT-DEP-06-016` | DEP-06 | `TAB_CHILD` | بنود فروق المطابقة البنكية | الرقابة والإقفال | `finance/bank_reconciliation_fin.php` |
| `NT-DEP-06-017` | DEP-06 | `MENU_ITEM` | عهد النثرية وتسويتها | الرقابة والإقفال | `finance/tre_petty_cash.php` |
| `NT-DEP-06-018` | DEP-06 | `MENU_ITEM` | الجرد النقدي للخزائن | الرقابة والإقفال | `finance/tre_cash_count.php` |
...
| `NT-DEP-07-003` | DEP-07 | `NOT_BUILT` | خطة القوى العاملة | التوظيف والتعاقد | — |
...
| `NT-DEP-07-019` | DEP-07 | `MENU_ITEM` | المزايا والتأمينات | الاستحقاق والصرف | `employees/hr_benefits.php` |
| `NT-DEP-07-020` | DEP-07 | `MENU_ITEM` | السلف والقروض | الاستحقاق والصرف | `workforce/employee_advances.php` |
| `NT-DEP-07-021` | DEP-07 | `MENU_ITEM` | مسيّر الرواتب | الاستحقاق والصرف | `workforce/payroll_runs.php` |
| `NT-DEP-07-022` | DEP-07 | `TAB_CHILD` | أسطر مسيّر الرواتب | الاستحقاق والصرف | `workforce/payroll_lines.php` |
| `NT-DEP-07-023` | DEP-07 | `MENU_ITEM` | التصفية النهائية | الاستحقاق والصرف | `workforce/final_settlement.php` |
...
| `NT-DEP-08-002` | DEP-08 | `MENU_ITEM` | سجل الشركات والكيانات | الكيان والتفويض | `governance/entities_registry.php` |
| `NT-DEP-08-003` | DEP-08 | `MENU_ITEM` | سجل السياسات | الكيان والتفويض | `governance/policies.php` |
| `NT-DEP-08-004` | DEP-08 | `MENU_ITEM` | سجل الالتزامات التنظيمية | الكيان والتفويض | `governance/obligations.php` |
| `NT-DEP-08-005` | DEP-08 | `MENU_ITEM` | تقويم الامتثال | الكيان والتفويض | `governance/compliance_calendar.php` |
| `NT-DEP-08-006` | DEP-08 | `MENU_ITEM` | التفويض بالتوقيع | الكيان والتفويض | `governance/signing_authority.php` |
| `NT-DEP-08-007` | DEP-08 | `MENU_ITEM` | التراخيص والكفالات | المستندات والالتزام | `governance/licenses_guarantees.php` |
| `NT-DEP-08-008` | DEP-08 | `MENU_ITEM` | التقديمات النظامية | المستندات والالتزام | `governance/regulatory_filings.php` |
...
| `NT-DEP-08-020` | DEP-08 | `MENU_ITEM` | مراقبة الأحداث والطابور | الأنظمة المرجعية | `governance/bus_board.php` |
...
| `NT-DEP-08-027` | DEP-08 | `MENU_ITEM` | سجل أنواع المستندات | الأنظمة المرجعية | `governance/doc_types.php` |
| `NT-DEP-08-028` | DEP-08 | `MENU_ITEM` | تفسير مصدر الصلاحية | الأدوار والصلاحيات | `governance/perm_explain.php` |
| `NT-DEP-08-029` | DEP-08 | `MENU_ITEM` | أنماط تفعيل المزايا | الأنظمة المرجعية | `governance/activation_patterns.php` |
| `NT-DEP-08-030` | DEP-08 | `MENU_ITEM` | اللجان وحوكمة الاجتماعات | الأنظمة المرجعية | `governance/committees.php` |
| `NT-DEP-08-031` | DEP-08 | `MENU_ITEM` | سجل أنواع الطلبات والتوجيه | الأنظمة المرجعية | `governance/doc_types.php` |
| `NT-DEP-08-032` | DEP-08 | `MENU_ITEM` | تمرين الاستعادة ومحضره | الأنظمة المرجعية | `governance/dr_restore.php` |
| `NT-DEP-09-001` | DEP-09 | `LANDING_PAGE` | لوحة المخاطر المؤسسية | اللوحة — خارج الدورة | `risk/risk_board.php` |
| `NT-DEP-09-002` | DEP-09 | `MENU_ITEM` | تصنيف المخاطر | التأسيس المرجعي | `risk/risk_taxonomy.php` |
| `NT-DEP-09-003` | DEP-09 | `MENU_ITEM` | سجل المخاطر المؤسسي | السجل والتقييم | `risk/risk_register.php` |
| `NT-DEP-09-004` | DEP-09 | `TAB_CHILD` | أحداث المخاطر والخسائر | السجل والتقييم | `risk/risk_events.php` |
| `NT-DEP-09-005` | DEP-09 | `TAB_CHILD` | تقييم المخاطر | السجل والتقييم | `risk/risk_assessment.php` |
| `NT-DEP-09-006` | DEP-09 | `TAB_CHILD` | الضوابط الرقابية | السجل والتقييم | `risk/risk_controls.php` |
| `NT-DEP-09-007` | DEP-09 | `MENU_ITEM` | خطط معالجة المخاطر | المعالجة والمراقبة | `risk/risk_treatments.php` |
| `NT-DEP-09-008` | DEP-09 | `TAB_CHILD` | مؤشرات المخاطر الرئيسة | المعالجة والمراقبة | `risk/risk_kris.php` |
| `NT-DEP-09-009` | DEP-09 | `MENU_ITEM` | قبول المخاطر | القرار والإغلاق | `risk/risk_acceptance.php` |
| `NT-DEP-09-010` | DEP-09 | `MENU_ITEM` | تصعيدات المخاطر | القرار والإغلاق | `risk/risk_escalations.php` |
| `NT-DEP-09-011` | DEP-09 | `MENU_ITEM` | المراجعة الدورية وإعادة التقييم | القرار والإغلاق | `risk/risk_reviews.php` |
| `NT-DEP-09-012` | DEP-09 | `MENU_ITEM` | سجل الإغلاق والأدلة | القرار والإغلاق | `risk/risk_closure.php` |
...
| `NT-DEP-10-002` | DEP-10 | `MENU_ITEM` | صندوق بلاغات الإدارة | السجلات التابعة | `Tickets/tickets_list.php` |
...
| `NT-DEP-10-005` | DEP-10 | `MENU_ITEM` | كتالوج أنواع محل البلاغ | دورة البلاغ | `tickets/tkt_subject_types.php` |
| `NT-DEP-10-006` | DEP-10 | `MENU_ITEM` | تسجيل البلاغ | دورة البلاغ | `tickets/ticket_form.php` |
| `NT-DEP-10-007` | DEP-10 | `TAB_CHILD` | تاريخ توجيه البلاغ | السجلات التابعة | `tickets/tkt_routing.php` |
| `NT-DEP-10-008` | DEP-10 | `TAB_CHILD` | تاريخ إسناد البلاغ | السجلات التابعة | `tickets/tkt_assignment.php` |
| `NT-DEP-10-009` | DEP-10 | `TAB_CHILD` | إجراءات معالجة البلاغ | السجلات التابعة | `tickets/tkt_resolution_actions.php` |
| `NT-DEP-10-010` | DEP-10 | `TAB_CHILD` | مراسلات البلاغ | السجلات التابعة | `tickets/tkt_communications.php` |
| `NT-DEP-10-011` | DEP-10 | `TAB_CHILD` | تصعيد البلاغ | السجلات التابعة | `tickets/tkt_escalation.php` |
| `NT-DEP-10-012` | DEP-10 | `TAB_CHILD` | إعادة فتح البلاغ | السجلات التابعة | `tickets/tkt_reopen.php` |
...
| `NT-DEP-11-002` | DEP-11 | `MENU_ITEM` | الخطة الموسمية ومعاملاتها | التخطيط والتوزيع | `operations/ops_seasonal_factors.php` |
| `NT-DEP-11-003` | DEP-11 | `MENU_ITEM` | الخطة الشهرية للتشغيل | التخطيط والتوزيع | `operations/monthly_plan.php` |
| `NT-DEP-11-004` | DEP-11 | `MENU_ITEM` | احتياج الغد وتوزيع الموارد | التخطيط والتوزيع | `operations/ops_tomorrow_dispatch.php` |
| `NT-DEP-11-005` | DEP-11 | `MENU_ITEM` | طلب وقرار حركة الموارد | التخطيط والتوزيع | `operations/ops_resource_move_orders.php` |
| `NT-DEP-11-006` | DEP-11 | `MENU_ITEM` | التايم شيت اليومي | اليوم التشغيلي | `timesheet/timesheet.php` |
| `NT-DEP-11-007` | DEP-11 | `TAB_CHILD` | توزيع زمن الوردية وحالاته | اليوم التشغيلي | `operations/ops_shift_time_states.php` |
| `NT-DEP-11-008` | DEP-11 | `MENU_ITEM` | اعتماد الوحدات | الاعتماد والمطابقة | `approvals/hours_approval.php` |
| `NT-DEP-11-009` | DEP-11 | `MENU_ITEM` | قرارات التوقف | الانحراف والاستثناء | `operations/ops_stop_decisions.php` |
| `NT-DEP-11-010` | DEP-11 | `MENU_ITEM` | سجل الأحداث التشغيلية | الانحراف والاستثناء | `workforce/worker_worklog.php` |
| `NT-DEP-11-011` | DEP-11 | `MENU_ITEM` | تقرير الانحراف والتصعيد | الإقفال والتقارير | `operations/ops_deviation_escalation.php` |
| `NT-DEP-11-012` | DEP-11 | `MENU_ITEM` | الإقفال الشهري للتشغيل | الإقفال والتقارير | `operations/monthly_close.php` |
...
| `NT-DEP-12-005` | DEP-12 | `MENU_ITEM` | فتح يوم الموقع | اليوم الميداني | `operations/site_day_open.php` |
| `NT-DEP-12-006` | DEP-12 | `TAB_CHILD` | ورديات اليوم | التنفيذ اليومي | `operations/site_day_shifts.php` |
| `NT-DEP-12-007` | DEP-12 | `MENU_ITEM` | تسجيل وحدات اليوم | اليوم الميداني | `operations/site_day_units.php` |
| `NT-DEP-12-008` | DEP-12 | `MENU_ITEM` | محضر اعتماد الموقع | الاعتماد الميداني | `operations/site_day_approval.php` |
| `NT-DEP-12-009` | DEP-12 | `MENU_ITEM` | محضر تسليم واستلام الورديات | الاعتماد الميداني | `operations/site_shift_handover.php` |
| `NT-DEP-12-010` | DEP-12 | `MENU_ITEM` | طلبات تغيير الحالة ومعالجة المتعثر | المعالجة الميدانية | `operations/site_state_requests.php` |
| `NT-DEP-12-011` | DEP-12 | `TAB_CHILD` | بنود طلب الموقع | المعالجة الميدانية | `operations/site_request_items.php` |
| `NT-DEP-12-012` | DEP-12 | `MENU_ITEM` | طلبات الموقع للصرف والاستلام | المعالجة الميدانية | `operations/site_supply_requests.php` |
| `NT-DEP-12-013` | DEP-12 | `TAB_CHILD` | دفعات استلام طلب الموقع | المعالجة الميدانية | `operations/site_request_batches.php` |
| `NT-DEP-12-014` | DEP-12 | `MENU_ITEM` | قرار الاستعداد أو التعطل | التنفيذ اليومي | `operations/site_stop_decision.php` |
| `NT-DEP-12-015` | DEP-12 | `MENU_ITEM` | صرف المشتريات الميدانية من العهدة | المعالجة الميدانية | `operations/site_field_expense.php` |
| `NT-DEP-12-016` | DEP-12 | `MENU_ITEM` | تقرير إقفال يوم الموقع | الإقفال والسجلات | `operations/site_day_close_report.php` |
| `NT-DEP-12-017` | DEP-12 | `MENU_ITEM` | الإيقاف المؤقت للموقع | الإقفال والسجلات | `operations/site_suspension.php` |
| `NT-DEP-12-018` | DEP-12 | `MENU_ITEM` | إغلاق الموقع وتسريحه | الإقفال والسجلات | `operations/site_closure_items.php` |
| `NT-DEP-12-019` | DEP-12 | `MENU_ITEM` | سجلات الموقع المرجعية | الإقفال والسجلات | `operations/site_reference_registry.php` |
| `NT-DEP-13-001` | DEP-13 | `LANDING_PAGE` | لوحة القوى التشغيلية | اللوحة — خارج الدورة | `workforce/wf_board.php` |
| `NT-DEP-13-002` | DEP-13 | `MENU_ITEM` | احتياج المشروع من القوى | الاحتياج والتغطية | `workforce/workforce_requirement.php` |
| `NT-DEP-13-003` | DEP-13 | `MENU_ITEM` | المطلوب مقابل المتوفر | الاحتياج والتغطية | `workforce/wf_coverage.php` |
| `NT-DEP-13-004` | DEP-13 | `MENU_ITEM` | الترشيح والاختيار للتغطية | الاحتياج والتغطية | `workforce/wf_nomination.php` |
| `NT-DEP-13-005` | DEP-13 | `MENU_ITEM` | عقود المشاريع المرجعية | الاحتياج والتغطية | `workforce/wf_project_contracts_ref.php` |
| `NT-DEP-13-006` | DEP-13 | `MENU_ITEM` | تصنيف الفئات التشغيلية | التأهيل والجاهزية | `workforce/wf_taxonomy.php` |
| `NT-DEP-13-007` | DEP-13 | `MENU_ITEM` | سجل الأفراد التشغيليين | التأهيل والجاهزية | `workforce/wf_person_register.php` |
| `NT-DEP-13-008` | DEP-13 | `TAB_CHILD` | التأهيل والشهادات | التأهيل والجاهزية | `workforce/wf_qualifications.php` |
| `NT-DEP-13-009` | DEP-13 | `MENU_ITEM` | مصفوفة التأهيل والجاهزية | التأهيل والجاهزية | `workforce/wf_qualification_matrix.php` |
| `NT-DEP-13-010` | DEP-13 | `MENU_ITEM` | التخصيص للمشروع | التخصيص والحركة | `workforce/wf_project_allocation.php` |
| `NT-DEP-13-011` | DEP-13 | `MENU_ITEM` | تخصيص المعدة والوردية | التخصيص والحركة | `workforce/wf_equipment_shift_assignment.php` |
| `NT-DEP-13-012` | DEP-13 | `MENU_ITEM` | الحركة والتواجد اليومي | التخصيص والحركة | `workforce/wf_daily_presence.php` |
| `NT-DEP-13-013` | DEP-13 | `MENU_ITEM` | التناوب والبدلاء | التخصيص والحركة | `workforce/wf_rotation_backup.php` |
| `NT-DEP-13-014` | DEP-13 | `MENU_ITEM` | أداء الأفراد التشغيلي | الأداء والتسوية | `workforce/wf_performance.php` |
| `NT-DEP-13-015` | DEP-13 | `MENU_ITEM` | التسوية ونهاية التخصيص | الأداء والتسوية | `workforce/wf_settlement.php` |
| `NT-DEP-13-016` | DEP-13 | `MENU_ITEM` | وحدات السكن والإعاشة | الأداء والتسوية | `workforce/housing_units.php` |
| `NT-DEP-13-017` | DEP-13 | `MENU_ITEM` | وقائع الميدان والإحالة التأديبية | الأداء والتسوية | `workforce/wf_field_incidents.php` |
| `NT-DEP-14-001` | DEP-14 | `LANDING_PAGE` | لوحة الصيانة والجاهزية | اللوحة — خارج الدورة | `maintenance/dashboard_mnt.php` |
| `NT-DEP-14-002` | DEP-14 | `MENU_ITEM` | شجرة الأعطال المرجعية | التأسيس المرجعي | `maintenance/fault_tree.php` |
...
| `NT-DEP-14-013` | DEP-14 | `MENU_ITEM` | الخطة الوقائية بالساعات | الوقائية | `Maintenance/preventive_plans.php` |
| `NT-DEP-14-014` | DEP-14 | `MENU_ITEM` | العناية اليومية والتشحيم | الوقائية | `maintenance/daily_care.php` |
| `NT-DEP-14-015` | DEP-14 | `MENU_ITEM` | الإقفال وشهادة إعادة الخدمة | الإقفال والجاهزية | `maintenance/return_to_service_cert.php` |
| `NT-DEP-14-016` | DEP-14 | `MENU_ITEM` | سجل إعادة الإصلاح | الإقفال والجاهزية | `maintenance/repeat_repairs.php` |
...
| `NT-DEP-15-011` | DEP-15 | `TAB_CHILD` | بنود تكلفة الرحلة | الإقفال والتكلفة | `transport/transfer_close_cost.php` |
| `NT-DEP-15-012` | DEP-15 | `MENU_ITEM` | إقفال أمر الترحيل | الإقفال والتكلفة | `transport/transfer_closure.php` |
| `NT-DEP-15-013` | DEP-15 | `MENU_ITEM` | تقرير أوامر الترحيل | الإقفال والتكلفة | `transport/transfer_orders_report.php` |
| `NT-DEP-16-001` | DEP-16 | `LANDING_PAGE` | لوحة المشتريات | اللوحة — خارج الدورة | `procurement/dashboard_proc.php` |
| `NT-DEP-16-002` | DEP-16 | `MENU_ITEM` | طلبات الشراء | الطلب والتجميع | `procurement/requests_proc.php` |
| `NT-DEP-16-003` | DEP-16 | `TAB_CHILD` | بنود طلب الشراء | الطلب والتجميع | `procurement/requests_proc.php` |
| `NT-DEP-16-004` | DEP-16 | `MENU_ITEM` | تجميع الطلبات وخطة الشراء | الطلب والتجميع | `procurement/proc_packages.php` |
| `NT-DEP-16-005` | DEP-16 | `TAB_CHILD` | أعضاء حزمة التجميع | الطلب والتجميع | `procurement/proc_packages.php` |
| `NT-DEP-16-006` | DEP-16 | `MENU_ITEM` | طلب العروض | العروض والترسية | `procurement/rfq_compare_award.php` |
| `NT-DEP-16-007` | DEP-16 | `TAB_CHILD` | دعوات الموردين للعروض | العروض والترسية | `procurement/proc_rfq.php` |
| `NT-DEP-16-008` | DEP-16 | `TAB_CHILD` | عروض الموردين المستلمة | العروض والترسية | `procurement/proc_offers.php` |
| `NT-DEP-16-009` | DEP-16 | `TAB_CHILD` | بنود عروض الموردين | العروض والترسية | `procurement/proc_offers.php` |
| `NT-DEP-16-010` | DEP-16 | `MENU_ITEM` | محضر المقارنة والترسية | العروض والترسية | `procurement/proc_award_minutes.php` |
| `NT-DEP-16-011` | DEP-16 | `MENU_ITEM` | أوامر الشراء | الأمر والتوريد | `procurement/orders_proc.php` |
| `NT-DEP-16-012` | DEP-16 | `TAB_CHILD` | بنود أمر الشراء | الأمر والتوريد | `procurement/orders_proc.php` |
| `NT-DEP-16-013` | DEP-16 | `MENU_ITEM` | استثناءات الشراء وتعديلات الأوامر | الأمر والتوريد | `procurement/proc_po_amendments.php` |
| `NT-DEP-16-014` | DEP-16 | `MENU_ITEM` | متابعة التوريد والاستلام | الأمر والتوريد | `procurement/proc_delivery_track.php` |
| `NT-DEP-16-015` | DEP-16 | `MENU_ITEM` | مطابقة الفاتورة الثلاثية | المطابقة والإقفال | `procurement/po_match.php` |
| `NT-DEP-16-016` | DEP-16 | `MENU_ITEM` | تقييم أداء التوريد | المطابقة والإقفال | `procurement/proc_supplier_eval.php` |
| `NT-DEP-17-001` | DEP-17 | `LANDING_PAGE` | لوحة المخازن | اللوحة — خارج الدورة | `procurement/warehouse_board.php` |
| `NT-DEP-17-002` | DEP-17 | `MENU_ITEM` | سجل المخازن وأنواعها | التأسيس المرجعي | `procurement/warehouses.php` |
| `NT-DEP-17-003` | DEP-17 | `TAB_CHILD` | إسناد أمناء المخازن | التأسيس المرجعي | `procurement/wh_custodians.php` |
| `NT-DEP-17-004` | DEP-17 | `MENU_ITEM` | دليل الأصناف | التأسيس المرجعي | `procurement/items_proc.php` |
...
| `NT-DEP-17-016` | DEP-17 | `MENU_ITEM` | الجرد ومعالجة الفروقات | الرقابة والإقفال | `procurement/wh_count.php` |
| `NT-DEP-17-017` | DEP-17 | `TAB_CHILD` | بنود الجرد والفروقات | الرقابة والإقفال | `procurement/wh_count.php` |
| `NT-DEP-17-018` | DEP-17 | `MENU_ITEM` | حدود الطلب وإعادة التزويد | الرقابة والإقفال | `procurement/reordering_proc.php` |
| `NT-DEP-17-019` | DEP-17 | `MENU_ITEM` | الإقفال الشهري للمخازن | الرقابة والإقفال | `procurement/wh_month_close.php` |
...
| `NT-IAF-002` | IAF | `MENU_ITEM` | ميثاق المراجعة الداخلية | الميثاق والخطة | `audit/iaf_charter.php` |
| `NT-IAF-003` | IAF | `MENU_ITEM` | سجل الكون الرقابي | الميثاق والخطة | `audit/iaf_universe.php` |
| `NT-IAF-004` | IAF | `MENU_ITEM` | الخطة السنوية للمراجعة | الميثاق والخطة | `audit/iaf_plan.php` |
| `NT-IAF-005` | IAF | `MENU_ITEM` | سجل الاستقلال وتعارض المصالح | الميثاق والخطة | `audit/iaf_independence.php` |
| `NT-IAF-006` | IAF | `MENU_ITEM` | مهام المراجعة | تنفيذ المهمة وأدلتها | `audit/iaf_engagements.php` |
| `NT-IAF-007` | IAF | `TAB_CHILD` | برامج المراجعة | تنفيذ المهمة وأدلتها | `audit/iaf_audit_programs.php` |
| `NT-IAF-008` | IAF | `MENU_ITEM` | طلبات الأدلة | تنفيذ المهمة وأدلتها | `audit/iaf_evidence_requests.php` |
| `NT-IAF-009` | IAF | `TAB_CHILD` | العينات ونتائج الاختبارات | تنفيذ المهمة وأدلتها | `audit/iaf_test_samples.php` |
| `NT-IAF-010` | IAF | `TAB_CHILD` | أوراق العمل | تنفيذ المهمة وأدلتها | `audit/iaf_workpapers.php` |
| `NT-IAF-011` | IAF | `MENU_ITEM` | سجل الاطلاع الحساس للمراجعين | تنفيذ المهمة وأدلتها | `audit/iaf_access_log.php` |
| `NT-IAF-012` | IAF | `MENU_ITEM` | الملاحظات | الملاحظات والتوصيات | `audit/iaf_findings.php` |
| `NT-IAF-013` | IAF | `MENU_ITEM` | تقارير المراجعة | الملاحظات والتوصيات | `audit/iaf_reports.php` |
| `NT-IAF-014` | IAF | `MENU_ITEM` | خطط المعالجة والمتابعة | المتابعة والإغلاق | `audit/iaf_action_plans.php` |
| `NT-IAF-015` | IAF | `MENU_ITEM` | الملاحظات المتأخرة والتصعيد | المتابعة والإغلاق | `audit/iaf_escalations.php` |
| `NT-IAF-016` | IAF | `MENU_ITEM` | تقييم الجودة | المتابعة والإغلاق | `audit/iaf_quality.php` |
| `NT-IAF-017` | IAF | `MENU_ITEM` | مخاطر وظيفة المراجعة | الحوكمة والضوابط | `audit/iaf_function_risks.php` |
| `NT-WS-MY-001` | WS-MY | `MENU_ITEM` | إنجازي | مساحتي الشخصية | `portal/my_achievement.php` |
| `NT-WS-MY-002` | WS-MY | `MENU_ITEM` | بوابتي | مساحتي الشخصية | `portal/my_portal.php` |
| `NT-WS-MY-003` | WS-MY | `MENU_ITEM` | مهامي | عملي اليومي | `portal/my_tasks.php` |
| `NT-WS-MY-004` | WS-MY | `MENU_ITEM` | طلباتي | عملي اليومي | `finrequests/request_form.php` |
| `NT-WS-MY-005` | WS-MY | `MENU_ITEM` | بلاغاتي | عملي اليومي | `portal/my_reports.php` |
| `NT-WS-MY-006` | WS-MY | `MENU_ITEM` | صفاتي والتبديل بينها | مساحتي الشخصية | `user_capacities.php` |
| `NT-WS-MY-007` | WS-MY | `TAB_CHILD` | تغيير كلمة المرور والأمان الشخصي | مساحتي الشخصية | `settings/change_password.php` |
