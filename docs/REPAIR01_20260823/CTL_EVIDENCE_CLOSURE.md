...
> ⛔ **مولَّدٌ من تشغيلٍ حيّ**: `php tools/ctl_evidence_closure.php --md` · اللقطة `SNAP-4feaeada-20260830-174328`

| المفردة | العدد |
|---|---:|
| منفَّذٌ غيرُ مثبتٍ بأسطحِه | 212 |
| **أُغلق بالدليل** (E1..E4) | **0** |
| قراءةٌ سقطت في E4 | 0 |
| قراءةٌ مفتوحةٌ بسببٍ قبل E4 | 14 |
| معاملاتٌ (عقدُها يطلب عينًا ومسارًا سالبًا) | 176 |
...
⛔ **المعاملاتُ لا تُغلق بأداة** — عقدُها بنصِّه يشمل تحقّقًا بشريًّا ومسارًا سالبًا يُشغَّل (تقدُّمُها الآليُّ: حارسٌ 176/176 · آلةُ حالةٍ 2/176).
