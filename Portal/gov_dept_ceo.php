...
if (function_exists('ems_states_bundle')) {
    echo ems_states_bundle('لا سجلاتِ حوكمةٍ لمكتبِ الرئيسِ ضمن هذا النطاق',
                           'تُقرأ الحساباتُ والصلاحياتُ وسجلاتُ التدقيقِ من مصادرِها الحية — راجع الدورَ أو النطاق');
}
