...
<div class="main ems-unified-page-shell">
    ...
    <div class="card"><div class="card-header"><h5><i class="fa fa-clipboard-list"></i> قيادة الازمات والطوارئ بحقول الورقة</h5></div>
    <div class="card-body"><div class="table-container">
        ...
        $GUIDE_COLS = array(
            ...
            'Site/Project' => 'g253',
            'Declared_At' => 'g254',
            'Incident_Commander مرجع القائد' => 'g255',
            'People_Impact' => 'g256',
            'Operational_Impact' => 'g257',
            'Financial_Impact' => 'g258',
            'Legal_Regulatory_Impact' => 'g259',
            'مرجع الحدث الأصلي' => 'g260',
            'Immediate_Actions Decision Event' => 'g261',
            'Decisions_Required' => 'g262',
            'Next_Update_At' => 'g263',
            'External_Communication_Status' => 'g264',
            'Current_Status' => 'g265',
            'Stand_Down_Date' => 'g266',
            'المنشئ' => 'g267',
            'تاريخ الإنشاء' => 'g268',
            'حالة البيانات' => 'g269',
            'مرجع المصدر' => 'g270',
        ...
        $D = array();
        $__gridRows = ems_w14_guide_rows('exec_crisis_case');
        echo ems_w14_grid('emsList_exec_crisis_case', $GUIDE_COLS, $__gridRows, $D, 'لا سطر مسجل بعد في قيادة الازمات والطوارئ'); /* /GUIDE_COLS */ ?>
    </div></div></div>
    <?php  ?>
