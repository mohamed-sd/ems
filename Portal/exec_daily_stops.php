...
<div class="main ems-unified-page-shell">
    ...
    <div class="card"><div class="card-header"><h5><i class="fa fa-clipboard-list"></i> تفصيل توقفات اليوم بحقول الورقة</h5></div>
    <div class="card-body"><div class="table-container">
        ...
        $GUIDE_COLS = array(
            ...
            'مسؤول التوقف' => 'g66',
            'أثر الفوترة' => 'g67',
            'مرجع السجل الأصلي' => 'g68',
        );
        $D = array();
        $__gridRows = ems_w14_guide_rows('exec_daily_stop');
        echo ems_w14_grid('emsList_exec_daily_stop', $GUIDE_COLS, $__gridRows, $D, 'لا سطر مسجل بعد في تفصيل توقفات اليوم'); /* /GUIDE_COLS */ ?>
    </div></div></div>
    <?php  ?>
