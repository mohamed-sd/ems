<?php
/**
 * Portal/ceo_risk.php — المخاطر والقرارات العليا (CMP-03 ⑥ — بُنيت بتصميم SCR-DES حرفيًّا)
 * ───────────────────────────────────────────────────────────────────────────
...
<div class="main ems-unified-page-shell" dir="rtl">
    ...
    <div class="card"><div class="card-body">
        ...
        <table class="alltables display" id="ceo_riskTable">
            ...
            <tbody>
                <tr><td colspan="17" class="text-center text-muted">لا بياناتَ بعدُ — تُعرض حين يُربط مصدرُها</td></tr>
            </tbody>
        </table>
        </div>
    </div></div>
