...
/* ◆ دوالُّ عقدِ الأعمدةِ في مصبٍّ واحدٍ يشترك فيه المُصيِّرُ وأداةُ البناء —
     فقائمةُ «ما لا يُصيَّر» لا تُنسخ مرّتَين فتنجرف. */
require_once __DIR__ . '/u13_screen_kit_cols.php';
...
<?php
/* ── إغلاقُ الجسدِ — شرطُ حقنِ زرِّ «أبلغ عن مشكلة» ──────────────────────────
     `includes/report_button.php:90` يحقن الزرَّ قبلَ `</body>` ويردُّ المُخرَجَ
     كما هو إن لم يجد جسدًا. وهذه العُدّةُ آخرُ ما تُصيِّره **138 شاشةً** ولم تكن
     تُغلق — فسقطت عنها كلِّها نقطةُ الإبلاغِ الإلزاميّةُ صامتةً.
     ◆ ولا ازدواجَ: قِيست الشاشاتُ الـ138 فصفرٌ منها يُغلق جسدَه بنفسِه. */
?>
</body>
</html>
