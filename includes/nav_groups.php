...
if (!function_exists('ems_nav_group_pins')) {
    ...
    function ems_nav_group_pins()
    {
        return array(
            ...
            /* الشاشةُ الموحَّدةُ للطلبِ الماليّ (إنشاءٌ وقائمةٌ وسجل) تبقى **حيث
               كانت** — قرارُ المالك 2026-08-21: «أظهِر الصفحةَ الجديدةَ في نفسِ
               الأماكنِ التي كانت فيها القديمة». وكنتُ نقلتُها إلى `MINE`
               باجتهادٍ لم يُطلَب، فأُعيدت. ولا خيارَ ثالثٌ هنا: `uxuiNavBaseRoute`
               يجرّد المرساةَ والمعامل، و«الرابطُ ذو المرساةِ يرث مجموعةَ ملفِّه
               الأم» — فالمسارُ الواحدُ مجموعةٌ واحدةٌ في كلِّ الأدوار. */
