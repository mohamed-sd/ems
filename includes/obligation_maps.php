...
$OBL_TYPES = array(
    'fuel'                => 'الوقود والزيوت',
    'access_road'         => 'الطريق والممر وتهيئة الموقع',
    'loading_equipment'   => 'معدات التحميل / المادة المنقولة',
    'equipment_readiness' => 'جاهزية المعدة والصيانة',
    'operators'           => 'المشغلون والسائقون',
    'permits_safety'      => 'التصاريح والأمن والسلامة',
    'utilities'           => 'الماء والكهرباء ومرافق الموقع',
    'catering_camp'       => 'الإعاشة والمعسكر',
    'force_majeure'       => 'الظروف القاهرة',
);
...
$OBL_OBLIGORS = array(
    ...
    'supplier' => 'المورد',
    'operator' => 'المشغل',
    'none'     => 'لا طرف ملتزما (قاهرة)',
);

/** أثرُ الإخلال على الفوترة — والافتراضُ `per_clause` أي «اقرأ البند» لا حكمًا مشتقًّا صامتًا. */
$OBL_EFFECTS = array(
    'billable_standby' => 'استعداد مفوتر',
    'non_billable'     => 'غير مفوتر',
    'per_clause'       => 'بحسب نص البند',
);
