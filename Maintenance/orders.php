...
/* AC-P1A · AC-F2 — حارسُ الكتابةِ المركزيُّ **قبلَ كلِّ فرعٍ كاتب**:
   الشاشةُ تحرس كلَّ فرعٍ على حدة ($can_add/$can_edit)، وذلك صحيحٌ لكنه
   **يعتمد على أن يتذكّر كاتبُ الفرعِ التالي حارسَه**. والحارسُ هنا يجعل
   المنعَ بنيويًّا: أيُّ POST كاتبٍ من دورٍ بصلاحيةِ عرضٍ وحدَها يُردُّ عند
        ...
        <div class="table-container">
            <table id="ordersTable" class="display nowrap alltables no-datatable mnt-w100" data-order='[[1, "desc"]]'>
                <thead><tr>
                    ...
                    <th class="ems-fn-th" data-fn="1">نتيجة الفحص النهائي</th>
