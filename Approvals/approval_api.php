...
/* INJ-0219 — الحارسُ باسمِ الشاشةِ التي تملكه فعلًا.
   ═══════════════════════════════════════════════════════════════════════════
   ◆ كان يرث `Approvals/hours_approval.php` — و**هي ليست شاشتَه الأم**: المُنادي
     الوحيدُ لهذا المعالجِ هو `Approvals/requests.php` (قِيس مسحًا للمستودعِ كلِّه).
     فكان معالجٌ عامٌّ لكلِّ أنواعِ الكياناتِ محكومًا بصلاحيةِ شاشةِ **ساعاتِ
     العمل** وحدَها؛ ومن ملك الصندوقَ ولم يملك الساعاتِ حُجب عن اعتمادِه.
   ◆ والأثرُ المقيس: الدورُ 19 (الإدارةُ المالية) بلا منحٍ على شاشةِ الساعاتِ
     إطلاقًا ⇒ الخطوةُ المالية في أيِّ سلّمٍ **مسدودةٌ بنيويًّا**.
   ◆ ولا يفقد أحدٌ شيئًا: هجرةُ 2027_01_29 تمنح `can_edit` على الصندوقِ لاتحادِ
     {من يملكها على الساعاتِ} ∪ {أدوارُ سلّمِ الخصم} — فالتحويلُ توسيعٌ مقيسٌ
     لا إزاحة. */
ems_guard_handler($conn, 'Approvals/requests.php', 'edit');
