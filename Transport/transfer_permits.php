...
<div class="main ems-unified-page-shell" dir="rtl">
    ...
    <div class="card"><div class="card-body">
        ...
        <table class="alltables display" id="transfer_permitsTable">
            ...
            <th>معرف التصريح</th><th>رقم الأمر</th><th>نطاق التصريح</th><th>مرفق التصريح</th><th>حالة التصريح</th><th>المنشئ</th><th>حالة البيانات</th><th>مرجع المصدر</th></tr></thead>
            <tbody>
            <?php if (!$rows): ?>
            ...
            <?php else: foreach ($rows as $r): ?>
                <tr<?php echo $r['is_seed'] ? ' data-seed="1"' : ''; ?>>
                    ...
                    <?php endforeach; ?>
                <?= ems_sf_cells($r, array('permit_uid', 'order_no', 'permit_scope', 'permit_attachment', 'permit_state', 'creator_name', 'data_state', 'source_ref')) ?></tr>
