<?php
/**
 * Transport/gov_dept_trp.php — حوكمة النقل والترحيل
 * ─────────────────────────────────────────────────────────────────────────
 * ظهورٌ نطاقيٌّ لمكوّن «حوكمة الإدارة» الواحد على النقل والترحيل:
 ...
 * يمنح، ونطاقُه `gov_dept_trp` يُطابَق على سجلِّ الشاشاتِ في المعالج.
 *
 * ◆ عدّادُ الأحداثِ مقصورٌ على `source_module = 'transport'` — فما ظهر صفرًا
...
$__pp = check_page_permissions($conn, 'Transport/gov_dept_trp.php');
...
if (function_exists('ems_states_bundle')) {
    echo ems_states_bundle('لا بياناتِ حوكمةٍ للنقل والترحيل ضمن النطاق الحالي',
                           'تُقاس اللوحةُ من حساباتِ النقل وصلاحياتِ شاشاتِه وسجلاتِ تدقيقِه — راجعِ النطاقَ أو الفترة');
}
