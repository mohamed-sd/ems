...
if (function_exists('ems_states_bundle')) {
    echo ems_states_bundle('لا بيانات حوكمة للنقل والترحيل ضمن النطاق الحالي',
                           'تقاس اللوحة من حسابات النقل وصلاحيات شاشاته وسجلات تدقيقه — راجع النطاق أو الفترة');
}
