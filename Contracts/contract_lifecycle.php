...
if (!$can_view) { header("Location: ../main/dashboard.php?msg=لا+توجد+صلاحية+عرض+دورة+الحياة+❌"); exit(); }
...
$redirect = function ($msg, $c = 0) {
    header("Location: contract_lifecycle.php?msg=" . rawurlencode($msg)
        . ($c > 0 ? ('&contract=' . $c) : ''));
    exit();
};
    ...
    <div class="card-body"><div class="table-container">
        <table class="alltables display nowrap no-datatable" data-no-dt="1" style="width:100%">
            <thead><tr><th>الحالة</th><th>المقدَّم</th><th>الضمان</th>
                <th>المنفَّذُ غيرُ المفوتر</th><th>الغرامات</th><th>الحاويات</th></tr></thead>
            <tbody>
