...
if (!$can_view) { header("Location: ../main/dashboard.php?msg=لا+توجد+صلاحية+عرض+خط+الأساس+❌"); exit(); }
...
$redirect = function ($msg, $c = 0) {
    header("Location: contract_baseline.php?msg=" . rawurlencode($msg)
        . ($c > 0 ? ('&contract=' . $c) : ''));
    exit();
};
    ...
    <div class="card-body"><div class="table-container">
        <table class="alltables display nowrap no-datatable" data-no-dt="1" style="width:100%">
            <thead><tr><th>النسخة</th><th>الحال</th><th>راجع</th><th>اعتمد</th><th>أقفل</th>
                <th>البصمة</th><th>المكوّنات وقتَ القفل</th><th>السبب</th></tr></thead>
            <tbody>
