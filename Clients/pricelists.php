...
if (!function_exists('pl_redirect_with_msg')) {
    ...
    {
        ems_gov_flash_redirect('pricelists.php', $msg, 'GOV-INFO-200', '');
        exit();
    }
}
...
$pl_csrf_token = generate_csrf_token();
...
if (!$can_view) {
    ems_gov_flash_redirect('../main/dashboard.php', 'لا توجد صلاحية عرض قوائم الأسعار ❌', 'GOV-PERM-403', '');
    exit();
}
