...
$uom_csrf_token = generate_csrf_token();
            ...
            <div class="card-body">
                <div class="form-grid">
                    <div id="generated_code_wrapper" class="auto">
                        ...
                        <input type="text" id="generated_uom_code" class="generated-code-field" value="<?php echo uom_e($next_uom_code); ?>" readonly tabindex="-1" title="هذا الكود للعرض فقط، يمكنك نسخه واستخدامه في حقل الكود" />
                    ...
                    <div>
                        ...
                        <input type="text" name="uom_code" id="uom_code" placeholder="مثال: UOM-001" required
                            value="<?php echo uom_e($next_uom_code); ?>"
                            pattern="[A-Za-z0-9_\-]+" />
                    </div>
                    <div>
                ...
                <div class="pu-form-actions">
                    <button type="submit" class="btn-primary"><i class="fas fa-save"></i> <span id="submitBtnText">حفظ الوحدة</span></button>
                    <button type="button" id="uomFormCancelBtn" class="btn-secondary"><i class="fas fa-times"></i> إلغاء</button>
                </div>
            </div>
        </div>
    </form>
...
<script>
    ...
    function setEditMode() { formTitle.text('تعديل وحدة القياس'); submitBtnText.text('تحديث الوحدة'); setGeneratedCodeShown(false); }
