...
<div class="main project-users-main ems-unified-page-shell">
    ...
    <?php
    /* PERM-01 — لافتةُ «تعامل قديم»: أعلامُ الكتابةِ في قائمةِ شاشاتِ المعاونِ
       تُقرأ من الجدولِ الذي لم يعد يحكم، فما يُعرض هنا ليس حكمَ الحارسِ اليوم. */
    require_once __DIR__ . '/../includes/legacy_perm_notice.php';
    ems_legacy_perm_notice('read', 'وأعلام الإضافة والتعديل والحذف في قائمة شاشات المعاون مأخوذة من هذا الجدول القديم.');
    ?>
