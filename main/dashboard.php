...
if ($dashboardRole == "0" || $dashboardRole == "1") {
  ...
  // معطلة = إجمالي - تعمل (نفس معادلة الدور 3)
...
<div class="dash main">
  ...
  <div class="d-top">
    ...
    <div class="d-top-mid">
      ...
      <?php if ($projectName): ?>
        <span class="d-badge d-badge-proj"><i
            class="fas fa-project-diagram"></i><?= htmlspecialchars($projectName) ?></span>
      <?php endif; ?>
      <?php if ($companyName !== ''): ?>
      ...
      <div class="d-scroll">
        ...
        <?php else: ?>
          <div class="d-sbar">
            ...
            <?php if ($companyName !== ''): ?><span class="d-si"><i
                  class="fas fa-building"></i><?= htmlspecialchars($companyName) ?></span><?php endif; ?>
            <?php if ($projectName): ?><span class="d-si gr"><i
                  class="fas fa-project-diagram"></i><?= htmlspecialchars($projectName) ?></span><?php endif; ?>
