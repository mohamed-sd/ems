...
$error = '';
/* ── INJ-0492 · شاشةُ الدخولِ تملك نصوصَها ولا تطبع ما في الرابط ─────────────
     كان `?msg=<نص>` يُطبع كما ورد — فأيُّ رابطٍ مُعدَّلٍ يعرض ما شاء صاحبُه على
     شاشةِ الدخولِ نفسِها (وهي أخطرُ موضعٍ: عندها يُدخل المستخدمُ كلمتَه).
     صار المُمرَّرُ **رمزًا** من قائمةٍ مغلقة، والنصُّ هنا. ورمزٌ غيرُ معروفٍ
     لا يُظهر شيئًا — فلا رسالةَ بلا مصدرٍ في النظام. */
$__loginMsgs = array(
    'suspended' => 'تم تسجيل الخروج: الشركة موقوفة حالياً.',
    'nocompany' => 'لا توجد بيئة شركة صالحة لهذا المستخدم.',
    'timeout'   => 'انتهت الجلسة — سجّل الدخول من جديد.',
    'loggedout' => 'تم تسجيل الخروج بنجاح.',
);
if (isset($_GET['m']) && isset($__loginMsgs[(string) $_GET['m']])) {
    $error = $__loginMsgs[(string) $_GET['m']];
}
unset($_GET['msg'], $_REQUEST['msg']);   /* نصٌّ في الرابطِ يُنزع ولا يُعرض */
