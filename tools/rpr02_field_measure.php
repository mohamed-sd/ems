...
/* ═══ ① التطبيعُ والتمييزُ والانتزاعُ — **في العُدّةِ المشتركةِ لا هنا** ═══
 * ◆ **نُقلت كما هي** إلى `tools/lib/rpr02_field_lib.php` **بلا حرفٍ يتغيّر**،
 *   لأنَّ `GOV_UI_FINISH` §٨·③ استلزم قارئًا ثانيًا يقرأ **الناتجَ المُصيَّر**
 *   (`tools/govui_finish_render.php`)، **وقارئان بقاعدتَي قبولٍ منفصلتَين
 *   يتفرّقان** ([[counter-parity-two-readers]]). فالقاعدةُ صارت واحدةً بالبنيةِ
 *   لا بالانضباط، **والمقيسُ لم يتحرّك**: 2703 قبلَ النقلِ و2703 بعدَه.
 * ⛔ **وهذا الملفُّ يبقى المقياسَ الرسميّ** — والمُثبِتُ يُثبت التصييرَ ولا يَعُدُّ.
 * ═══════════════════════════════════════════════════════════════════════════ */
