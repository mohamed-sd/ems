...
array(
    ...
    'map' => array(
        ...
        /* ═══ وسبعةُ `SUP-33` — **سطحٌ واحدٌ يخدم هدفَين** ══════════════════
           ◆ **المقيسُ حرفًا**: `Suppliers/supplier_inference_rules.php` مربوطٌ
             بهدفَين باسمٍ واحد: `SAL-25` في `DEP-01` (‏11 حقلًا) و`SUP-33` في
             `DEP-02` (‏7 حقول) — **ومجموعتا الحقولِ مختلفتان لا متداخلتان**.
           ◆ و§9 يقول: «مكرَّرة ⇒ **حافظ على Source Screen واحدة** واستخدم
             أكثرَ من `Placement`» — فالشاشةُ واحدةٌ **وتحمل الاتحادَ**.
           ⛔ **وأوّلُ صيغةٍ أغلقت الأحدَ عشرَ فكسرت السبعةَ** (0/7): إغلاقُ
             وجهٍ يهدم الآخرَ إن نُسي أنَّ للسطحِ وجهَين. */
        'كود القاعدة'             => 'code_rule',
        'الحقل/المخرج'            => 'c2',
        'القيم الممكنة'           => 'c3',
        'قاعدة الاشتقاق'          => 'c4',
        'الشيت المطبَّق فيه'      => 'c5',
        'القيد/التحذير'           => 'c6',
