...
$add('AC-E06-03', 'صفرُ متطلبٍ بلا اختبار', 'OPEN',
    'مصفوفةُ التتبع (2,221 متطلبًا ↔ اختبارها) لم تُبنَ آليًّا — موجةُ عملٍ مستقلة');
...
$add('AC-E06-06', 'القبولُ بتنفيذٍ لا مشاهدة', 'OPEN',
    'القالبُ جاهزٌ (UAT_SIGNOFF_TEMPLATE) والبوابةُ ④ تفحص حداثته — والمحضرُ بيد المستخدمين');
