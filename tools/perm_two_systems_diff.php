...
echo "\n   ② يسمح و① يمنع = " . number_format($byCode['tpl']) . "  ⇐ توسعةٌ لم يُصدرها قرار\n";
echo "   ① يسمح و② يمنع = " . number_format($byCode['rol']) . "  ⇐ "
   . ((int) $byCode['rol'] === 0 ? "صفر — لا ممنوحَ محجوب" : "⛔ ارتفعَ عن صفرٍ: منحٌ حيٌّ يُحجب") . "\n";
