 ...
 *                  INJ-0146 · INJ-0576 · INJ-0492 · INJ-0442 · INJ-0571 · INJ-0237
 *                  INJ-0501 · INJ-0158 · INJ-0441 · INJ-0378 · INJ-0548 · INJ-0499
 *                  INJ-0236
 *
 * ── النطاق ────────────────────────────────────────────────────────────────
...
$BY_WITNESS = array(
 ...
 '`?msg=✅ تم الحفظ` يُظهر نجاحًا لفعلٍ لم يقع في ١٥٦ شاشةً ⇒ **صفرٌ** · ٣١ موضعًا حُوِّل إلى وميضِ الجلسة'),
    'INJ-0442' => array('inline_styles_test', 'Contracts/contracts_details.php',
 'كتلتا `<style>` و٤٣ لونًا صلبًا ⇒ **صفرٌ وصفر** في شاشتَي العقود'),
    'INJ-0571' => array('inline_styles_test', 'Timesheet/timesheet.php',
 'أسوأُ ملفٍّ قياسًا: ٢٠٨ سمةً و١٩١ لونًا ⇒ **٤ سماتٍ** (مشتقّةٌ من بيان) و**صفرُ كتلة**'),
    'INJ-0237' => array('inline_styles_test', 'assets/css/ems-screens.css',
 '٢٨٢ سمةَ `style=` في الشاشاتِ الثمانِ ⇒ **٨** · وصفرُ كتلةٍ · و٤٨ كيلوبايتَ نُقلت بصفرِ لونٍ صلب'),
    'INJ-0501' => array('inline_styles_test', 'admin/includes/layout_head.php',
 'لوحةُ الإدارةِ تُعرّف ١٨ رمزًا خاصًّا ولا تعرف ملفَّ المنتج ⇒ **ملفٌّ واحدٌ** ورموزٌ دلاليةٌ مشتركة'),
    'INJ-0158' => array('supplier_kpi_cards_test', 'Suppliers/supplier_profile.php',
 'ستُّ بطاقاتٍ برقمٍ عارٍ ⇒ **العقدُ السباعيُّ كاملًا** · والحقلُ الحساسُ يُنزع من الاستجابةِ لمن لا يملك مصدرَه'),
    'INJ-0441' => array('contracts_layout_test', 'Contracts/contracts.php',
 'الجدولُ يبدأ عند 31.5٪ وثمانيةُ أزرارٍ متساويةٍ و١٧ كتلةً موضعيةً ⇒ **27.9٪** وفعلٌ رئيسٌ واحدٌ وصفرُ نمطٍ موضعيّ'),
    'INJ-0378' => array('offline_outbox_test', 'Timesheet/timesheet.php',
 'صفرُ تخزينٍ محليٍّ وصفرُ عاملِ خدمةٍ في المستودعِ كلِّه ⇒ **طابورٌ في IndexedDB** ومفتاحُ عطالة: إعادةٌ تُعلَن «مُطبَّقٌ سلفًا» وصفرُ صفٍّ ثانٍ'),
    'INJ-0548' => array('offline_outbox_test', 'Transport/transfer_arrival.php',
 'تأكيدُ الوصولِ بلا شبكةٍ يضيع ⇒ **نموذجٌ موسومٌ للطابورِ** ومفتاحُ العميلِ في عطالةِ العقد · وحجبُ الكتابةِ يُعلَن برمزِه'),
    'INJ-0499' => array('template_layers_test', 'includes/u13_screen_kit.php',
 'طبقتا قوالبَ بنمطِ رأسٍ وشرحٍ وفراغٍ ورسالةٍ لكلٍّ ⇒ **المكوّناتُ الأربعةُ نفسُها** في الثلاثِ وصفرُ كتلةِ أنماطٍ خاصة'),
    'INJ-0236' => array('shell_entries_test', 'includes/public_shell.php',
 'مساراتٌ مستقلةٌ تُصدر `<html>` ⇒ **صفرُ شاشةِ منتجٍ** خارجَ خمسةِ مداخلَ معتمدة · ١٢ شاشةَ ما-قبلَ-دخولٍ حُوِّلت'),
