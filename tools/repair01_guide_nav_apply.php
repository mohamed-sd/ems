...
/* ⚠ **ونزعي الأوّلُ غطّى 064B–0652 وترك اثنَين فأسقط `W6`**:
     **التطويلَ** (`0640`) في «هـ · الرقابة الفنية»، **والشرحَ الإنجليزيَّ**
     بين قوسَين في «اللوحة — خارج الدورة (Overview)».
     ⇒ **ودستورُ النظامِ يحظر المصطلحَ التقنيَّ الظاهر** — فالاسمُ العربيُّ
     هو الاسمُ **والشرحُ الإنجليزيُّ زينةٌ تُنزَع**، وليس هذا مخالفةً لقرارِ
     المالكِ (أ) بل إعمالًا لقاعدةٍ أعلى منه في الترتيب. */
$clean = function ($s) {
