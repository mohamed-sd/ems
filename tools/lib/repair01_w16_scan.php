...
function repair01_w16_axis_defs()
{
    return array(
        ...
        /* ⛔ **ولا اداة لهذا المحور بحبة المتطلب**: ولا دفتر رحلة من الثلاثة عشر
           يحمل معرف متطلب - فالمحطات مقيدة بالكيان والشوط. وكتابة صفر هنا تقرا
           «لا تغطية الية» وهو كذب. فيعلن غير مقيس ويطبع المقيس الحقيقي في سببه. */
        array('TEST', 7, 'اختبار',
            'لا اداة تنسب التغطية الالية الى نطاق - ولا دفتر رحلة يحمل معرف متطلب',
            'لا مقام - غير مقيس · والمقيس الحقيقي محطات الرحلات مطبوع في سبب كل صف',
            'غير مقيس باعلان: التغطية الالية قائمة بمحطاتها ولكنها لا تنسب الى نطاق - '
            . 'والقبول البشري محور مستقل عنها'),
