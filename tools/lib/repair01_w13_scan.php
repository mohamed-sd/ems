...
function repair01_w13_anchors()
{
    return array(
        ...
        'TKT-06' => array('route' => 'Tickets/tkt_assignment.php', 'probe' => 'tkt_assignment_history',
                          'kind' => 'TABLE', 'step' => 35,
                          'why' => 'كل تغيير مكلف سطر بسببه ولا مكلف بلا وقت استلام'),
        'TKT-07' => array('route' => 'Tickets/tkt_resolution_actions.php', 'probe' => 'tkt_resolution_action',
                          'kind' => 'TABLE', 'step' => 36,
                          'why' => 'كل اجراء سطر بمرجعه في شاشة الادارة المعالجة - المعالجة عند مالكها'),
        'TKT-08' => array('route' => 'Tickets/tkt_communications.php', 'probe' => 'ticket_communications',
                          'kind' => 'TABLE', 'step' => 37,
                          'why' => 'دور المركز تواصل موثق - كل تواصل سطر بقناته ووقته'),
        'TKT-09' => array('route' => 'Tickets/tkt_escalation.php', 'probe' => 'ticket_escalations',
                          'kind' => 'TABLE', 'step' => 38,
                          'why' => 'التصعيد الي بمستوياته عند تجاوز المهل ولا يسكت الا بمعالجة'),
        'TKT-10' => array('route' => 'Tickets/tkt_reopen.php', 'probe' => 'tkt_reopen',
                          'kind' => 'TABLE', 'step' => 39,
        ...
        'TKT-11' => array('route' => 'Tickets/tkt_verification.php', 'probe' => 'tkt_verification',
                          'kind' => 'TABLE', 'step' => 40,
