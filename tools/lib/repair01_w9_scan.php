...
function repair01_w9_anchors()
{
    return array(
        ...
        'WH-03'  => array('route' => 'Procurement/items_proc.php', 'probe' => 'proc_item', 'kind' => 'TABLE',
                          'why' => 'دليل الاصناف — دليل موحد واحد ولا صنف بتكويدين؛ واعلام التتبع مشتقة من سجل الفئات'),
        /* ── دورة الاستلام ─────────────────────────────────────────────── */
        'WH-04'  => array('route' => 'Procurement/wh_receipt.php', 'probe' => 'proc_receipt_custody', 'kind' => 'TABLE',
                          'why' => 'سند الادخال والفحص — راس بمورده وامره وبنوده تابعة'),
        'WH-05'  => array('route' => 'Procurement/wh_receipt.php', 'probe' => 'proc_receipt_line', 'kind' => 'TABLE',
                          'why' => 'بنود سند الادخال — الوارد والمقبول والمرفوض وبيانات التتبع بالانطباق'),
        'WH-06'  => array('route' => 'Procurement/stock_proc.php', 'probe' => 'proc_stock_state', 'kind' => 'TABLE',
                          'why' => 'ارصدة المخزون بحالاتها — صنف × مخزن × حالة سطر مشتق لا يكتب بيد'),
        'WH-07'  => array('route' => 'Procurement/wh_hazmat.php', 'probe' => 'proc_hazmat_control', 'kind' => 'TABLE',
                          'why' => 'ضوابط المواد الخطرة — سجل لكل صنف لا قائمة صلبة والتصريح شرط صرف'),
        /* ── دورة الصرف ────────────────────────────────────────────────── */
        'WH-08'  => array('route' => 'Procurement/wh_issue_requests.php', 'probe' => 'proc_issue_request', 'kind' => 'TABLE',
                          'why' => 'طلبات الصرف الواردة — طلب × جهة والجهة تطلب والمخزن يصرف'),
        'WH-09'  => array('route' => 'Procurement/wh_issue_requests.php', 'probe' => 'proc_issue_request_line', 'kind' => 'TABLE',
                          'why' => 'بنود طلب الصرف — غير بنود السند وخفض المعتمد بسبب مكتوب'),
        'WH-10'  => array('route' => 'Procurement/issue_proc.php', 'probe' => 'proc_issue', 'kind' => 'TABLE',
                          'why' => 'سند الصرف — راس بمستلمه وبنوده تابعة'),
        'WH-11'  => array('route' => 'Procurement/issue_proc.php', 'probe' => 'proc_issue_line', 'kind' => 'TABLE',
                          'why' => 'بنود سند الصرف — بند × سند سجل تابع'),
        'WH-12'  => array('route' => 'Procurement/receipt_custody_proc.php', 'probe' => 'proc_custody', 'kind' => 'TABLE',
                          'why' => 'العهد والمرتجعات — عهدة × مستلم بمرتجعها ومستهلكها'),
        'WH-13'  => array('route' => 'Procurement/wh_transfer.php', 'probe' => 'proc_transfer', 'kind' => 'TABLE',
                          'why' => 'التحويل بين المخازن — امر × مخزنين والمرسل ليس المستلم'),
        'WH-14'  => array('route' => 'Procurement/wh_transfer.php', 'probe' => 'proc_transfer_line', 'kind' => 'TABLE',
                          'why' => 'بنود التحويل — بند × امر وفرق الاستلام بسبب مكتوب'),
        /* ── الرقابة والإقفال ──────────────────────────────────────────── */
        'WH-15'  => array('route' => 'Procurement/wh_count.php', 'probe' => 'proc_count_session', 'kind' => 'TABLE',
                          'why' => 'الجرد ومعالجة الفروقات — جلسة × مخزن وبنود الفروق تابعة'),
        'WH-16'  => array('route' => 'Procurement/wh_count.php', 'probe' => 'proc_count_line', 'kind' => 'TABLE',
                          'why' => 'بنود الجرد — صنف × جلسة بقرار تسوية مسبب والدفتري مشتق لا مكتوب'),
        'WH-17'  => array('route' => 'Procurement/reordering_proc.php', 'probe' => 'proc_orderpoint', 'kind' => 'TABLE',
                          'why' => 'حدود الطلب واعادة التزويد — صنف × مخزن سطر تنبيه مشتق'),
        'WH-18'  => array('route' => 'Procurement/wh_month_close.php', 'probe' => 'proc_wh_close', 'kind' => 'TABLE',
...
function repair01_w9_new_surfaces()
{
    return array(
        ...
        array('route' => 'Procurement/wh_hazmat.php', 'ar' => 'ضوابط المواد الخطرة والمتفجرات',
              ...
              'req' => 'WH-07', 'doc' => 'سطر ضوابط صنف خطر',
        ...
        array('route' => 'Procurement/wh_issue_requests.php', 'ar' => 'طلبات الصرف الواردة',
              ...
              'req' => 'WH-08 · WH-09', 'doc' => 'طلب صرف معتمد',
