...
/* ◆ **مخرَجُ عددٍ واحدٍ ليُعاد قياسُ الصنفِ آليًّا** (‏W16): مقياسُ `DC-18`
   **مسحُ كودٍ لا استعلامُ قاعدة**، وسجلُّ الأصنافِ كان يحمله بلا مقياسٍ أصلًا
   — **فصفرُه لم يكن يُثبت شيئًا**. والعددُ وحدَه هنا كي يقرأه السجلُّ ويعيد
   تشغيلَه، ⛔ **لا كي يُخزَّن رقمًا يُقرأ لاحقًا**. */
if (in_array('--count', $argv, true)) { echo count($E) . "\n"; exit(0); }
