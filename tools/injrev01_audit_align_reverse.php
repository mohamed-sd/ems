 ...
 * ◆ **قارئان كانا يبحثان عن رقمٍ في نصّ** لا عن قياس. والمصدرُ الآن واحدٌ:
 *   شاهدٌ يُشغَّل ويُصدِّر المقامَين معًا. (البند ١-٣) */
...
V($bridge ? 'DONE' : 'OPEN', 'NF-28 (P2) مقامانِ لعقدِ المعرِّفاتِ بلا جسر',
  $bridge ? 'المقامانِ **مقيسانِ ومُصدَّرانِ معًا** بجدولِ تحويل ·' . $nf28
          : '**لا جسرَ مقيسًا بين المقامَين** — الشاهدُ يرسُب');
