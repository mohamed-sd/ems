...
$md = "# NAV-D3 · حسم DEC-NAV-E صفًّا صفًّا — دمج «إدارة الموقع» في «الحركة والتشغيل»\n\n"
    . "> **★القرار المستنتج (ينتظر توقيع المالك):** الباقي قائمة الدور 6 «الحركة والتشغيل» — لأن ORG-01 يجعل مدير الحركة هو مدير الموقع تشغيليًّا، وللدور 6 نوع تكليف `site_movement_mgr` في البنية الجديدة والقيد «واحد نشط لكل موقع». "
