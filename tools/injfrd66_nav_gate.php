...
echo "◆ والمجموعةُ المُعلَنةُ **رأسُ طيٍّ** منذ RPR-OPS-02 — لا قسمًا تحتَ رأسِ\n"
   . "   غيرِها: كان رأسُ الطيِّ مفتاحُه المسارُ (nav_route_group بلا role_id)\n"
   . "   فلا يحمل مجموعةً لكلِّ دور، وصار يُشتقُّ من gov_target_nav لمن أعلن.\n"
   . "   ⛔ ولا يسري إلّا على المُعلَن — ومن لا صفَّ له على التصنيفِ الاثنَي عشر.\n";
