...
if (!$ISSUE) {
    ...
    array('W16-F-12', 'والعطب نفسه في موضع ثان: سجل الاصدار كان يختم لقطة لا تمثله',
      'الحاجب W16-21 بعد تشديده: لقطة الاصدار موجودة لكن التزامها غير التزام الاصدار',
      'اختيار اللقطة بـfrozen_at لا بالالتزام - وهو عطب W16-F-11 عينه في اداة الاشتقاق · صارت تاخذ النافذة المفتوحة ثم لقطة الالتزام الحالي بعينه وتقف ان لم تجد · وشدد الحاجب فصار يطابق commit_hash لا الوجود وحده',
      'قبل: الاصدار يختم SNAP-02224261 والتزامه 47577ee7 · بعد: الحاجب يسقط على الفرق والاصدار يختم لقطة التزامه'),
    );
...
if ($ISSUE) {
    ...
    /* ⚠ **واللقطةُ تُختار بالالتزامِ لا بالوقت** (‏العطبُ نفسُه الذي أصابَ جردَ
