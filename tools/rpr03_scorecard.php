...
/* ⑩ المحطاتُ الصامتة */
$add('محطاتٌ مبنيّةٌ بصفرِ صفّ', 'صفر', '٤ محطاتٍ · ٤٦٩ تسوية', null,
     '⛔ **غيرُ مقيس** — يحتاج جسرَ المحطّةِ إلى جدولِها');

/* ⑪ القيودُ اليدوية */
$add('قيودٌ يدويّةٌ بلا مصدرٍ ولا مبرِّرٍ ولا اعتماد', 'صفر', 'غيرُ مصنَّف', null,
     '⛔ **غيرُ مقيس** — التصنيفُ لم يُبنَ (§٨·١)');
...
$add('مسحٌ بنيويٌّ آليٌّ للأسطحِ القابلةِ للعرض', 'منفَّذ', 'غيرُ منفَّذ', null,
     '⛔ **غيرُ مقيس** — المسحُ لم يُبنَ (§٩)');
