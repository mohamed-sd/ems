...
<div class="main ems-unified-page-shell">
    ...
    ems_screen_about('مستوى الخطر الذي تقبله الشركة سعيا لأهدافها — يحدده الرئيس بحسب الخطة العامة، '
    ...
    echo ems_states_bundle('لا مجالات شهية مبذورة لهذا الكيان', 'شهية المخاطر تبذر بقرار الرئيس — والأرضيات الثلاث لا تتغير بحال');
    ?>
    <?php /* نُقلت أنماطُ هذه الشاشةِ إلى assets/css/ems-screens.css (UXUI-01 البند ٦: صفرُ نمطٍ محليّ) */ ?>
    <div class="card"><div class="card-body table-responsive">
        <table class="table table-striped rsk-w100">
            <thead><tr><th>المجال</th><th>الشهية</th><th>حد التحمل</th><th>المخول</th><th>التغير</th><th>أرضية ثابتة</th></tr></thead>
    ...
    <div class="ems-card rsk-plans-card">
        ...
        <ul class="rsk-plans-list">
            <li><b>النمو والتوسع:</b> ترفع شهية التعاقد والتشغيل والأفراد والتمويل — ولا ترفع السلامة ولا القانون ولا تسرب البيانات، وتشدد الضوابط المعوضة كلما رفعت.</li>
            <li><b>التثبيت والكفاءة:</b> تخفض شهية التعاقد الجديد والتمويل والتوسع الجغرافي — وترفع دقة المتابعة والوقائية، والتركيز على تقليل المتبقي لا قبوله.</li>
            <li><b>الحماية والانكماش:</b> تخفض الشهية في المجالات كلها — وترفع حدود التصعيد فيصل للرئيس ما كان يحسم أدنى، ويراجع كل قبول سابق.</li>
        </ul>
    </div>
</div>
</body>
