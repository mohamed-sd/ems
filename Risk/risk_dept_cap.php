<?php
/**
 * Risk/risk_dept_cap.php — مخاطر التمويل والملكية
 * ─────────────────────────────────────────────────────────────────────────
 * ظهورٌ نطاقيٌّ للمكوّن الواحد «مساحة مخاطر الإدارة» بزاوية التمويل والملكية
 * (RU-09: مخاطر التمويل والملكية والأصول) — «مكوّنٌ واحدٌ يتغير نطاقُه وعنوانُه بحسب
...
/* تثبيتُ الزاوية على وحدة «التمويل والملكية» من الهيكل الحي — لا رقمًا صلبًا */
$__u = null;
$__st = $conn->prepare("SELECT unit_id FROM org_units WHERE company_id = ? AND unit_code = 'financing' AND active = 1 LIMIT 1");
