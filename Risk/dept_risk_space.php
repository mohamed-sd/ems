...
/* INJ-0443/0544 — العنوانُ يُشتقُّ من إدارةِ المستخدمِ لا يُثبَّت: الشاشةُ واحدةٌ
   تخدم إداراتٍ عدّة، وعنوانٌ ثابتٌ يجعل تبويبَ المتصفحِ يكذب على من فتحها.
   وترويسةُ الصفحةِ تشتقُّه سلفًا (سطر 38) — فيُسوّى التبويبُ بها. */
$page_title = 'إيكوبيشن | مخاطر ' . ($unitName !== '' ? $unitName : 'الإدارة');
