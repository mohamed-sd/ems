<?php
/**
 * Risk/risk_dept_mnt.php — مخاطر الصيانة
 * ─────────────────────────────────────────────────────────────────────────
 * ظهورٌ نطاقيٌّ للمكوّن الواحد «مساحة مخاطر الإدارة» بزاوية الصيانة
 * (RU-03: مخاطر الصيانة والاعتمادية) — «مكوّنٌ واحدٌ يتغير نطاقُه وعنوانُه بحسب
...
/* تثبيتُ الزاوية على وحدة «الصيانة» من الهيكل الحي — لا رقمًا صلبًا */
$__u = null;
$__st = $conn->prepare("SELECT unit_id FROM org_units WHERE company_id = ? AND unit_code = 'maintenance' AND active = 1 LIMIT 1");
