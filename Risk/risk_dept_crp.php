<?php
/**
 * Risk/risk_dept_crp.php — مخاطر مركز البلاغات
 * ─────────────────────────────────────────────────────────────────────────
 * ظهورٌ نطاقيٌّ للمكوّن الواحد «مساحة مخاطر الإدارة» بزاوية مركز البلاغات
 * (RU-11: مخاطر التقنية والبيانات واستمرارية الأعمال) — «مكوّنٌ واحدٌ يتغير نطاقُه وعنوانُه بحسب
...
/* تثبيتُ الزاوية على وحدة «مركز البلاغات» من الهيكل الحي — لا رقمًا صلبًا */
$__u = null;
$__st = $conn->prepare("SELECT unit_id FROM org_units WHERE company_id = ? AND unit_code = 'tickets' AND active = 1 LIMIT 1");
