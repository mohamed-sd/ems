<?php
/**
 * Risk/risk_dept_prc.php — مخاطر المشتريات
 * ─────────────────────────────────────────────────────────────────────────
 * ظهورٌ نطاقيٌّ للمكوّن الواحد «مساحة مخاطر الإدارة» بزاوية المشتريات
 * (RU-06: مخاطر سلسلة الإمداد والمشتريات والمخازن) — «مكوّنٌ واحدٌ يتغير نطاقُه وعنوانُه بحسب
...
/* تثبيتُ الزاوية على وحدة «المشتريات» من الهيكل الحي — لا رقمًا صلبًا */
$__u = null;
$__st = $conn->prepare("SELECT unit_id FROM org_units WHERE company_id = ? AND unit_code = 'procurement_ops' AND active = 1 LIMIT 1");
