...
<div class="card" style="margin-bottom:14px;border-inline-start:4px solid #b45309">
  <div class="card-body" style="padding:14px 18px">
    <div style="display:flex;align-items:center;gap:10px;flex-wrap:wrap">
        ...
        <small class="text-muted"><?php echo htmlspecialchars(isset($legacy_view_note) ? $legacy_view_note : 'الخطر يسجل مركزيا ويعرض هنا بزاويته — هذه الشاشة ليست مصدرا (M-16 ورقة 32)'); ?></small>
