<?php
/**
 * Risk/risk_dept_flt.php — مخاطر الأسطول
 * ─────────────────────────────────────────────────────────────────────────
 * ظهورٌ نطاقيٌّ للمكوّن الواحد «مساحة مخاطر الإدارة» بزاوية الأسطول
...
/* تثبيتُ الزاوية على وحدة «الأسطول» من الهيكل الحي — لا رقمًا صلبًا */
$__u = null;
$__st = $conn->prepare("SELECT unit_id FROM org_units WHERE company_id = ? AND unit_code = 'fleet' AND active = 1 LIMIT 1");
