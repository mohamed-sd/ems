<?php
/**
 * Risk/risk_dept_wrk.php — مخاطر القوى التشغيلية
 * ─────────────────────────────────────────────────────────────────────────
 * ظهورٌ نطاقيٌّ للمكوّن الواحد «مساحة مخاطر الإدارة» بزاوية القوى التشغيلية
 * (RU-04: مخاطر القوى التشغيلية) — «مكوّنٌ واحدٌ يتغير نطاقُه وعنوانُه بحسب
...
/* تثبيتُ الزاوية على وحدة «القوى التشغيلية» من الهيكل الحي — لا رقمًا صلبًا */
$__u = null;
$__st = $conn->prepare("SELECT unit_id FROM org_units WHERE company_id = ? AND unit_code = 'operators' AND active = 1 LIMIT 1");
