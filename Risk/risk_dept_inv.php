<?php
/**
 * Risk/risk_dept_inv.php — مخاطر المخازن
 * ─────────────────────────────────────────────────────────────────────────
 * ظهورٌ نطاقيٌّ للمكوّن الواحد «مساحة مخاطر الإدارة» بزاوية المخازن
...
/* تثبيتُ الزاوية على وحدة «المخازن» من الهيكل الحي — لا رقمًا صلبًا */
$__u = null;
$__st = $conn->prepare("SELECT unit_id FROM org_units WHERE company_id = ? AND unit_code = 'warehouse' AND active = 1 LIMIT 1");
