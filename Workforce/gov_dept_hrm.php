<?php
/**
 * Workforce/gov_dept_hrm.php — حوكمة الموارد البشرية
 * ─────────────────────────────────────────────────────────────────────────
 * ظهورٌ نطاقيٌّ لمكوّن «حوكمة الإدارة» الواحد على الموارد البشرية:
 ...
 * يمنح، ونطاقُه `gov_dept_hrm` يُطابَق على سجلِّ الشاشاتِ في المعالج.
 *
 * ◆ عدّادُ الأحداثِ مقصورٌ على `source_module = 'hr'` — فما ظهر صفرًا
...
$__pp = check_page_permissions($conn, 'Workforce/gov_dept_hrm.php');
...
if (function_exists('ems_states_bundle')) {
    echo ems_states_bundle('لا قياساتِ فصلِ واجباتٍ معلَنةً لحوكمةِ الموارد البشرية',
                           'تُقاس القياساتُ على المستنداتِ الحيةِ للإدارة — وما لم يُقَس يُعلَن ولا يُلفَّق');
}
