...
$COLS   = array (
  ...
  19 => 'الحالة',
  20 => 'الكيان',
  21 => 'المنشئ — الاسم والصفة',
  22 => 'تاريخ الإنشاء',
  23 => 'المعتمد — الاسم والصفة',
  24 => 'تاريخ الاعتماد',
  25 => 'مرجع التفويض',
  26 => 'المرجع الأب',
  27 => 'المرفق',
...
<div class="main ems-unified-page-shell" dir="rtl">
    ...
    echo ems_states_bundle('لا دورات تناوب أو إجازة ميدانية مسجلة بعد', 'أضف أول دورة بزر «إضافة» في رأس الشاشة');
    ?>
    ...
    <form method="post" action="" class="allforms" id="cmp03AddForm">
        ...
        <div class="card"><div class="card-header">
            ...
            <div class="form-section"><div class="form-grid">
                ...
                <div class="form-group"><label for="emsf_1792_2d248">كود المشغل</label>
                ...
                <div class="form-group"><label for="emsf_1804_927ea">البديل عند تعذر التبادل</label>
                ...
                <div class="form-group"><label for="emsf_1811_85fa1">المعتمد — الاسم والصفة</label>
