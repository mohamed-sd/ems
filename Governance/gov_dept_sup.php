...
if (function_exists('ems_states_bundle')) {
    echo ems_states_bundle('لا قياساتِ فصلِ واجباتٍ ضمن نطاق الموردين',
                           'قياساتُ هذه الإدارةِ تُعرَّف على مستنداتِ الموردين الحية — راجع الفترةَ أو حسابات الدورين 2 و8');
}
