<?php
/**
 * Governance/portal_users.php — حسابات بوابة الأطراف الخارجية (CMP-03 ⑥ — بُنيت بتصميم SCR-DES حرفيًّا)
 * ───────────────────────────────────────────────────────────────────────────
...
<div class="main ems-unified-page-shell" dir="rtl">
    ...
    <div class="card"><div class="card-body">
        ...
        <table class="alltables display" id="portal_usersTable">
            ...
            <tbody>
                <tr><td colspan="20" class="text-center text-muted">لا بياناتَ بعدُ — تُعرض حين يُربط مصدرُها</td></tr>
            </tbody>
        </table>
        </div>
    </div></div>
