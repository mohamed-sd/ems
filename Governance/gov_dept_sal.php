...
if (function_exists('ems_states_bundle')) {
    echo ems_states_bundle('لا قياسات فصل واجبات ضمن نطاق المبيعات والعقود',
                           'قياسات هذه الإدارة تعرف على مستندات العقود والفرص الحية — راجع الفترة أو حسابات الدور 12');
}
