...
if (isset($_GET['delete_id'])) {
    ...
    if ($ops_count > 0) {
        ems_gov_flash_redirect('equipments_fleet.php', 'لا يمكن حذف المعدة لأنها بصدد التشغيل حالياً ❌', 'GOV-INFO-200', '');
        exit();
    }
    ...
    try {
        ...
        if ($del_row === null) {
            ems_gov_flash_redirect('equipments_fleet.php', 'حدث خطأ أثناء الحذف ❌', 'GOV-INFO-200', '');
            exit();
        }
