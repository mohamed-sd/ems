...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['currency'])) {
    ...
    if ($company_id <= 0)         { ems_gov_flash_redirect('orders_proc.php', 'لا يمكن الحفظ بلا شركة صالحة ❌', 'GOV-INFO-200', ''); exit(); }
    ...
    if ($state !== 'مسودة' && $fin_approval_ref === '') {
        ems_gov_flash_redirect('orders_proc.php', 'لا يصدر الأمر بلا مرجع اعتماد مالي ❌', 'GOV-INFO-200', ''); exit();
    }
