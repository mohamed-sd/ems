...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['name'])) {
    ...
    if ($company_id <= 0) {
        ems_gov_flash_redirect('master_data.php', 'لا يمكن الحفظ بلا شركة صالحة ❌', 'GOV-INFO-200', ''); exit();
    }
    ...
    if (!in_array($type, $mnt_lookup_types, true) || $name === '') {
        ems_gov_flash_redirect('master_data.php', 'بيانات غير مكتملة ❌', 'GOV-INFO-200', ''); exit();
    }
