...
if (!$can_view) { ems_gov_flash_redirect('../login.php', 'لا توجد صلاحية عرض المسميات الوظيفية ❌', 'GOV-PERM-403', ''); exit(); }
...
if (isset($_GET['delete_id'])) {
    ...
    if ($used > 0) {
        ems_gov_flash_redirect('job_titles.php', 'لا يمكن حذف مسمى مستخدمٍ من قِبل $used موظف ❌', 'GOV-INFO-200', '');
    } else {
