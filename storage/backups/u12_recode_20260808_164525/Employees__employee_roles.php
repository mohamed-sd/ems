...
if (!$can_view) { ems_gov_flash_redirect('../login.php', 'لا توجد صلاحية عرض أدوار الموظفين ❌', 'GOV-PERM-403', ''); exit(); }
...
if (isset($_GET['delete_id'])) {
    ...
    if ($used > 0) {
        ems_gov_flash_redirect('employee_roles.php', 'لا يمكن حذف دورٍ مستخدمٍ من قِبل $used موظف ❌', 'GOV-INFO-200', '');
    } else {
