...
if (isset($_GET['settle_supplier'])) {
    ...
    if (!fin_verify_action_token()) { ems_gov_flash_redirect('dues_fin.php', 'رمز الحماية غير صالح ❌', 'GOV-INFO-200', ''); exit(); } // إصلاح #2
    if (!fin_can_perform($conn, $ctx['role'], 'treasurer')) { ems_gov_flash_redirect('dues_fin.php', 'التسوية تخصّ أمين الخزينة فقط ❌', 'GOV-INFO-200', ''); exit(); } // فصل الواجبات
    ...
    <div class="card"><div class="card-body">
        ...
        <div class="table-container">
            <table id="recvTable" class="display nowrap alltables no-datatable" style="width:100%;">
              ...
              <th class="ems-fn-th" data-fn="1">أولوية السداد</th>
