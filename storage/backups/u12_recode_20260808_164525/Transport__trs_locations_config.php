...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['name'])) {
    ...
    if ($company_id <= 0)         { ems_gov_flash_redirect('trs_locations_config.php', 'لا يمكن الحفظ بلا شركة صالحة ❌', 'GOV-INFO-200', ''); exit(); }
    ...
    if ($name === '' || !array_key_exists($location_type, $loc_types)) {
        ems_gov_flash_redirect('trs_locations_config.php', 'بيانات غير مكتملة ❌', 'GOV-INFO-200', ''); exit();
    }
    ...
    try {
        ...
        ems_gov_flash_redirect('trs_locations_config.php', 'حدث خطأ أثناء الحفظ ❌', 'GOV-INFO-200', ''); exit();
    }
}
