<?php
// شواهد المتطلبات (AC-E06-03 · موجة ٣): IAM-002 · IAM-012 · IAM-021 · SCN-695 · SCN-696 · SCN-697 · SCN-925 · UXP-039 · UXP-115
/**
 * Governance/guards.php — تصنيف قواعد المنع (CMP-03 ⑥ v2 — بتصميم SCR-DES حرفيًّا + إدخال حي)
 * ───────────────────────────────────────────────────────────────────────────
 * الورقة المالكة: 15 · الحوكمة والالتزام · الأعمدة 21 بترتيب المستند وطبقة
...
$CANONICAL = 'guards.php';

// حارس الشاشة (M-14 BR-GOV-01): can_view من modules — والسوبر يمر
$__pp = check_page_permissions($conn, 'Governance/guards.php');
if (!$is_super_admin && empty($__pp['can_view'])) {
    require_once __DIR__ . '/../includes/perm_explain_live.php';
    $__why = ems_deny_message($conn, intval($_SESSION['user']['role'] ?? 0), 'Governance/guards.php');
...
<div class="main ems-unified-page-shell" dir="rtl">
    <?php
    $header_title = 'تصنيف قواعد المنع';
    $header_icon = 'fa fa-shield-halved';
