...
if (!$is_super_admin && $company_id <= 0) {
    ems_gov_flash_redirect('../login.php', 'Unauthorized company context', 'GOV-INFO-200', '');
    exit();
}
...
if (!$can_view) {
    ems_gov_flash_redirect('../login.php', 'لا توجد صلاحية عرض ساعات العمل ❌', 'GOV-PERM-403', '');
    exit();
}
