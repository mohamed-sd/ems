...
gapv('GAP-09', true, 'صفرُ صفِّ تصنيفٍ ملوَّثٍ نشطٍ برمزٍ خارجَ نمطِ DC-n', $bad);
gapv('GAP-12', false, 'ستُّ سياساتٍ بهدفٍ وهميٍّ باقيةٌ دَينًا مُعلَنًا — ولا يُدَّعى إغلاقُ تصنيفِ الحقولِ والحساسية', $bad);
