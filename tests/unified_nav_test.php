...
ok('الدور الرائد: 27 عنصرًا نشطًا (26 السابقة + خطة موارد العقد P-04 عرضًا — لا فقدان)',
    intval($conn->query("SELECT COUNT(*) FROM nav_items WHERE role_id = 1 AND active = 1")->fetch_row()[0]) === 27);
