...
ok('الدور الرائد: 26 عنصرًا نشطًا (25 السابقة + شروط تعديل السعر M-09 عرضًا — لا فقدان)',
    intval($conn->query("SELECT COUNT(*) FROM nav_items WHERE role_id = 1 AND active = 1")->fetch_row()[0]) === 26);
