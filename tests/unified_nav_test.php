...
ok('الدور الرائد: 25 عنصرًا نشطًا (24 السابقة + مواقع التنفيذ — لا فقدان)',
    intval($conn->query("SELECT COUNT(*) FROM nav_items WHERE role_id = 1 AND active = 1")->fetch_row()[0]) === 25);
