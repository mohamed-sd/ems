...
ok('الدور الرائد: 24 عنصرًا نشطًا (20 السابقة + الالتزامات + الإسناد + الجزاءات + الحاويات — لا فقدان)',
    intval($conn->query("SELECT COUNT(*) FROM nav_items WHERE role_id = 1 AND active = 1")->fetch_row()[0]) === 24);
