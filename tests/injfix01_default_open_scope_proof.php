...
gapv('GAP-22', true, 'نطاقُ المشروعِ الماليِّ مقلوبٌ إلى المنعِ الافتراضيّ — دورٌ غيرُ مصنَّفٍ يُرجع صفرَ صفّ', $fail);
gapv('GAP-30', true, 'البحثُ العامُّ مقلوبٌ إلى المنعِ الافتراضيّ — الشاشةُ غيرُ المسجَّلةِ لا تُفتح', $fail);
