...
/* ── INJ-0192 · الافتراضُ المُصرَّحُ ────────────────────────────────────────────
   يفترض هذا الفاحصُ قيدَ `ck_dues_debit_source` (يُمرّر `source_doc_type` في
   كلِّ خصمٍ) ولا يُثبته — ورفعُ القيدِ من القاعدةِ أبقاه أخضرَ (exit=0)، فامتثل
   ولم يحرس. والمُقرِّرُ مشترَكٌ لا منسوخ. */
