...
$core = array(
    ...
    'transfer_tariff_test', 'depreciation_event_test', 'periodic_events_test', 'bank_reconciliation_test', 'rfq_cycle_test', 'contract_sites_test', 'contract_lines_test', 'contract_monthly_plan_test', 'contract_resource_plan_test', 'contract_payment_schedule_test', 'contract_guarantees_test', 'allocation_targets_test', 'three_currencies_test', 'plan_actual_link_test', 'contract_baseline_test', 'lifecycle_economics_test', 'daily_plan_test', 'dues_source_doc_test', 'settlement_test', 'settlement_invoice_close_test',
