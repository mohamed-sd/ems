...
// ════════════════════════════════════════════════════════════════════════════
// 🔐 التحقق من صلاحيات المستخدم — نفس منهجية equipments_fleet.php
// ════════════════════════════════════════════════════════════════════════════
$page_permissions = check_page_permissions($conn, 'Operations/oprators.php');
...
if ($is_role10) {
    // إذا كان للمستخدم مشروع محدد في حسابه، استخدمه
    if ($user_project_id > 0) {
        ...
        // مشرف أسطول بدون مشروع محدد — يختار من select_project
