...
$U13 = array(
    ...
    'table'      => 'iaf_findings',
    'title'      => 'المصعد إلى الجهة المشرفة',
    'icon'       => 'fa fa-arrow-up-right-dots',
    'nature'     => 'read',
    'doc'        => 'IAF-01 §2-2 · IAF-0041',
    'intro'      => 'ما تجاوز مهلته فصعد آليا — ولا يملك أحد منعه',
    'rule'       => 'IAF §2-2: والتصعيد آلي بالمهلة ويصل الجهة المشرفة مباشرة',
    'empty_hint' => 'لا ملاحظات مصعدة',
