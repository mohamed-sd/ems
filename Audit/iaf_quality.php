...
$U13 = array(
    ...
    'intro'      => 'تقييم داخلي دوري وخارجي عند الانطباق',
    'rule'       => 'IAF-0031: والوظيفة التي تقيم غيرها تقيم',
    'empty_hint' => 'لا تقييمات جودة مسجلة',
...
if (function_exists('ems_states_bundle')) {
    echo ems_states_bundle('لا تقييمات جودة مسجلة',
                           'يسجل التقييم الداخلي دوريا والخارجي عند الانطباق (IAF-0008 · IAF-0031)');
}
