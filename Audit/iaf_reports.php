...
$U13 = array(
    ...
    'intro'      => 'التقرير يصل الجهة المشرفة مباشرة بمسار مسجل يفحص',
    'rule'       => 'CEO-Y0119: ولا يمر بالمالية ولا بالحوكمة ولا بمن يراجع',
    'empty_hint' => 'لا تقارير صادرة',
...
if (function_exists('ems_states_bundle')) {
    echo ems_states_bundle('لا تقارير مراجعة صادرة',
                           'يصدر التقرير عند اكتمال المهمة ويصل الجهة المشرفة مباشرة بمسار مسجل (IAF-0030)');
}
