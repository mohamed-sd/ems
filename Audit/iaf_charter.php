...
$U13 = array(
    ...
    'intro'      => 'الغرض والسلطة والمسؤولية والاستقلال — معتمدا من الجهة المشرفة',
    'rule'       => 'IAF-0004: لا تتبع المالية ولا رئيس الحسابات ولا الحوكمة في إصدار أحكامها',
    'empty_hint' => 'لا ميثاق معتمد بعد — ولا كون رقابي بلا ميثاق',

    'actions'    => array(
        'approve' => array(
            'code'  => 'iaf.charter.approve',
            'label' => 'اعتماد الميثاق',
            'rule'  => 'IAF-0044: ولا كون رقابي بلا ميثاق معتمد',
            'fields' => array('version' => 'نسخة الميثاق'),
...
if (function_exists('ems_states_bundle')) {
    echo ems_states_bundle('لا ميثاق معتمدا بعد لهذه الشركة',
                           'يعتمد ميثاق المراجعة الداخلية من الجهة المشرفة أولا — ولا كون رقابي بلا ميثاق معتمد');
}
