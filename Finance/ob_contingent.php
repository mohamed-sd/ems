...
$U13 = array(
    ...
    'intro'      => 'ما يفصح عنه في الإيضاحات ولا يقيد في الميزانية',
    'rule'       => 'OR-11: الالتزام المحتمل يفصح ولا يقيد · ولا يقيد مخصص إلا بقرار مالي مسبب ومعتمد',
    'empty_hint' => 'لا التزامات محتملة تستوجب إفصاحا',
...
if (function_exists('ems_states_bundle')) {
    echo ems_states_bundle('لا التزامات محتملة تستوجب إفصاحا ضمن هذا الترشيح',
                           'وسع الترشيح أو راجع سجل اختبارات التجنب');
}
