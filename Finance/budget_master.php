...
$header_title_html = htmlspecialchars('الموازنة العامة — ' . ($year), ENT_QUOTES, 'UTF-8');
$header_actions = array();
$header_back = false;
include __DIR__ . '/../includes/page_header.php';
// UXW-01 ⑨: حالاتُ الشاشةِ الثلاثُ من المكوّنِ المركزيّ
echo ems_states_bundle('لا ميزانيات معتمدة لهذه السنة', 'تحقق من اعتماد ميزانيات الإدارات للسنة المالية');
?>
