...
$FA_SCREEN = array(
    ...
    'about' => 'الحساب يشتق من نوع الواقعة ونموذج العمل ونوع العقد — ولا يختار يدويا. ولكل إدارة حدثها المصدر وحسابا الإيراد والتكلفة وأبعادها الإلزامية وبوابتها.',
    'notes' => array (
  0 => 'تعديل المصفوفة نسخة جديدة — والعكس إعادة السابقة',
  1 => 'الإدارات لا تكتب قيدا — تنشر حدثا والمالية تقيد',
),
    'context' => array(),
    'filters' => '',
);
...
?>
    ...
    <?php echo ems_states_bundle('لا صفوف نشطة في مصفوفة الترحيل', 'تزرع المصفوفة مع تهيئة الشركة — وتعديلها نسخة جديدة من هذه الشاشة'); ?>
