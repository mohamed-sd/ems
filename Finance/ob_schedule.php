...
$U13 = array(
    ...
    'intro'      => 'الطبقات الثلاث بأعمدة مستقلة — الارتباط والمعترف به والذمة',
    'rule'       => 'OBL-0137: لا تدمج ولا تقفز · SY-05: والفترة الكسرية موسومة صريحا',
    'empty_hint' => 'لا استحقاقات بعد — تولد دفعة واحدة مع الالتزام',
...
if (function_exists('ems_states_bundle')) {
    echo ems_states_bundle('لا استحقاقات ضمن هذا الترشيح',
                           'تولد الاستحقاقات دفعة واحدة مع الالتزام — وسع الترشيح أو راجع سجل الالتزامات');
}
