...
include("../config.php"); // Ù…Ù„Ù Ø§Ù„Ø§ØªØµØ§Ù„ Ø¨Ù‚Ø§Ø¹Ø¯Ø© Ø§Ù„Ø¨ÙŠØ§Ù†Ø§Øª
...
// Ø³Ø§Ø¹Ø§Øª Ø§Ù„Ø¹Ù…Ù„ (Ù…Ø¬Ù…ÙˆØ¹ total_work_hours)
...
<head>
  ...
  <title>Ù„ÙˆØ­Ø© Ø§Ù„ØªÙ‚Ø§Ø±ÙŠØ±</title>
  ...
  <style>
    ...
    /* Ø£Ù„ÙˆØ§Ù† Ù…Ø®ØªÙ„ÙØ© Ù„ÙƒÙ„ ÙƒØ§Ø±Ø¯ */
...
<?php include('../insidebar.php');?> 
 ...
 <div class="main">
  ...
  <div class="container py-4">
    ...
    <h1 class="text-center mb-5"> Ù„ÙˆØ­Ø© Ø§Ù„ØªÙ‚Ø§Ø±ÙŠØ± </h1>
    <div class="row g-4">
      ...
      <div class="col-md-4 col-sm-6">
        <div class="report-card bg-projects" onclick="location.href='projects_reports.php'">
          ...
          <div class="report-title">ØªÙ‚Ø±ÙŠØ± Ø§Ù„Ù…Ø´Ø§Ø±ÙŠØ¹</div>
      ...
      <div class="col-md-4 col-sm-6">
        <div class="report-card bg-suppliers" onclick="location.href='#'">
          ...
          <div class="report-title">ØªÙ‚Ø±ÙŠØ± Ø§Ù„Ù…ÙˆØ±Ø¯ÙŠÙ†</div>
      ...
      <div class="col-md-4 col-sm-6">
        <div class="report-card bg-equipments" onclick="location.href='equipments_reports.php'">
          ...
          <div class="report-title">ØªÙ‚Ø±ÙŠØ± Ø§Ù„Ø¢Ù„ÙŠØ§Øª</div>
      ...
      <div class="col-md-4 col-sm-6">
        <div class="report-card bg-operators" onclick="location.href='#'">
          ...
          <div class="report-title">ØªÙ‚Ø±ÙŠØ± Ø§Ù„Ù…Ø´ØºÙ„ÙŠÙ†</div>
      ...
      <div class="col-md-4 col-sm-6">
        <div class="report-card bg-users" onclick="location.href='#'">
          ...
          <div class="report-title">ØªÙ‚Ø±ÙŠØ± Ø§Ù„Ù…Ø³ØªØ®Ø¯Ù…ÙŠÙ†</div>
      ...
      <div class="col-md-4 col-sm-6">
        <div class="report-card bg-workhours" onclick="location.href='timesheet_reports.php'">
          ...
          <div class="report-title">ØªÙ‚Ø±ÙŠØ± Ø³Ø§Ø¹Ø§Øª Ø§Ù„Ø¹Ù…Ù„</div>
