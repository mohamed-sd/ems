...
class Installer
{
    ...
    public function install()
    {
        ...
        /* ══ INJ-0060 · «وبلا فحصٍ يمنع النشرَ عند خلوِّ الجدول» ═══════════════════
             ...
             `database/` يترك `gov_field_class` خاويًا — و**أربعٌ وأربعون شاشةً
             حاكمةً تُصيَّر «لا عمودَ مصنَّفٌ لهذه الشاشة»**. صار الجدولُ في البذرةِ
             المرجعية؛ وهذا الفحصُ يمنع أن يعود الخللُ صامتًا لو سقط منها يومًا.
           ◆ ويُفشل التثبيتَ صراحةً: **تثبيتٌ ينتهي بشاشاتٍ خاويةٍ أسوأُ من تثبيتٍ
             يرسب** — فالأولُ يُسلَّم ويُستعمل، والثاني يُصلَح. */
        $__gfc = $this->conn->query('SELECT COUNT(*) FROM gov_field_class');
