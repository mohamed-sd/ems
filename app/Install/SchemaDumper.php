...
class SchemaDumper
{
    ...
    const SEED_GLOBAL = array(
        ...
        'link_groups',
        'nav_items',
        /* ⇐ RPR-W02 §٤-٣ · نمطُ `gov_field_class` أدناه حرفًا: **السجلُّ صار شرطَ
             ظهورٍ لا زينة**. مراسي القشرةِ الخمسُ (الرئيسية · المراسلات · مركزا
             التقاريرِ · الإعدادات) كانت مساراتٍ حرفيّةً في ملفِّ القشرةِ تظهر
             مهما كانت القاعدةُ خاوية؛ وصارت تُقرأ من `nav_canonical.anchor_key`.
             فنشرٌ نظيفٌ بجدولٍ غيرِ مبذورٍ يعطي **سايدبارًا بلا رئيسيةٍ ولا
             مراسلات** — والجدولُ عالميٌّ بلا `company_id` و٣٨٨ صفًّا، فبذرُه
             رخيصٌ وغيابُه غالٍ.
             (ولا يُسمَّى ملفُّ القشرةِ هنا بحرفِه: كاشفُ `RP-01` يعدُّ كلَّ ملفٍّ
              يذكر اسمَه شاشةً حيّةً — فتعليقٌ يرفع الدَّينَ بواحد. التفصيلُ في
              `includes/nav_anchors.php`.) */
        'nav_canonical',
        'equipments_types',
        'failure_codes',
    );
