...
class TenantRegistry
{
    ...
    private static $tables = array(
        ...
        // ── لحاق E-04 (2026-08-06 · ق-15): جداول الموجات خارج السجل سُجّلت آليا ──
        'achievement_attributions' => array('type' => self::T_TENANT, 'soft' => false),
        'achievement_records' => array('type' => self::T_TENANT, 'soft' => false),
        'approval_links' => array('type' => self::T_TENANT, 'soft' => false),
        'attendance_sweep_notices' => array('type' => self::T_TENANT, 'soft' => false),
        'chain_objections' => array('type' => self::T_TENANT, 'soft' => false),
        'client_contracts' => array('type' => self::T_TENANT, 'soft' => true),
        'cmp03_screen_rows' => array('type' => self::T_TENANT, 'soft' => false),
        // CMP-03 الموجة ٢ (2026-08-06): جداول الشاشات المحررة من المخزن البيني —
        // 42 جدول scr_* مولدة بأداة cmp03_wave2_generate (كلها بعمود الكيان)
        'scr_access_review' => array('type' => self::T_TENANT, 'soft' => false),
        'scr_asset_recon' => array('type' => self::T_TENANT, 'soft' => false),
        'scr_attendance' => array('type' => self::T_TENANT, 'soft' => false),
        'scr_break_glass' => array('type' => self::T_TENANT, 'soft' => false),
        'scr_business_models' => array('type' => self::T_TENANT, 'soft' => false),
        'scr_canonical_names' => array('type' => self::T_TENANT, 'soft' => false),
        'scr_code_bridge' => array('type' => self::T_TENANT, 'soft' => false),
        'scr_consumption_rate' => array('type' => self::T_TENANT, 'soft' => false),
        'scr_contract_review' => array('type' => self::T_TENANT, 'soft' => false),
        'scr_deductions' => array('type' => self::T_TENANT, 'soft' => false),
        'scr_doc_types' => array('type' => self::T_TENANT, 'soft' => false),
        'scr_equipment_quota' => array('type' => self::T_TENANT, 'soft' => false),
        'scr_equipment_sourcing' => array('type' => self::T_TENANT, 'soft' => false),
        'scr_exceptions' => array('type' => self::T_TENANT, 'soft' => false),
        'scr_fin_assets' => array('type' => self::T_TENANT, 'soft' => false),
        'scr_fin_changes' => array('type' => self::T_TENANT, 'soft' => false),
        'scr_fin_models' => array('type' => self::T_TENANT, 'soft' => false),
        'scr_founding_mode' => array('type' => self::T_TENANT, 'soft' => false),
        'scr_guards' => array('type' => self::T_TENANT, 'soft' => false),
        'scr_monthly_close' => array('type' => self::T_TENANT, 'soft' => false),
        'scr_op_codes' => array('type' => self::T_TENANT, 'soft' => false),
        'scr_op_monthly' => array('type' => self::T_TENANT, 'soft' => false),
        'scr_op_qual' => array('type' => self::T_TENANT, 'soft' => false),
        'scr_ownership_links' => array('type' => self::T_TENANT, 'soft' => false),
        'scr_perm_explain' => array('type' => self::T_TENANT, 'soft' => false),
        'scr_portal_users' => array('type' => self::T_TENANT, 'soft' => false),
        'scr_production' => array('type' => self::T_TENANT, 'soft' => false),
        'scr_project_contracts' => array('type' => self::T_TENANT, 'soft' => false),
        'scr_release_stamp' => array('type' => self::T_TENANT, 'soft' => false),
        'scr_rotation' => array('type' => self::T_TENANT, 'soft' => false),
        'scr_sensitive_fields' => array('type' => self::T_TENANT, 'soft' => false),
        'scr_shift_log' => array('type' => self::T_TENANT, 'soft' => false),
        'scr_site_gate_equip' => array('type' => self::T_TENANT, 'soft' => false),
        'scr_site_gate_person' => array('type' => self::T_TENANT, 'soft' => false),
        'scr_site_shift_plan' => array('type' => self::T_TENANT, 'soft' => false),
        'scr_site_work_calendar' => array('type' => self::T_TENANT, 'soft' => false),
        'scr_state_machines' => array('type' => self::T_TENANT, 'soft' => false),
        'scr_transfer_fleet' => array('type' => self::T_TENANT, 'soft' => false),
        'scr_transfer_permits' => array('type' => self::T_TENANT, 'soft' => false),
        'scr_unbilled' => array('type' => self::T_TENANT, 'soft' => false),
        ...
        'exec_dept_caps' => array('type' => self::T_TENANT, 'soft' => false),
        'exec_project_charters' => array('type' => self::T_TENANT, 'soft' => false),
        'personal_notifications' => array('type' => self::T_TENANT, 'soft' => false),
        'recurring_tasks' => array('type' => self::T_TENANT, 'soft' => false),
        ...
        'task_templates' => array('type' => self::T_TENANT, 'soft' => false),
        'unified_fault_taxonomy' => array('type' => self::T_GLOBAL, 'soft' => false),
        'work_delegations' => array('type' => self::T_TENANT, 'soft' => false),
        'work_escalations' => array('type' => self::T_TENANT, 'soft' => false),
        'work_items' => array('type' => self::T_TENANT, 'soft' => false),
        'workspace_views' => array('type' => self::T_TENANT, 'soft' => false),
        ...
        'visibility_audit_log' => array('type' => self::T_TENANT, 'soft' => false),
        ...
        'contract_resource_plan' => array('type' => self::T_TENANT, 'soft' => true),
        ...
        'contract_operational_sites' => array('type' => self::T_TENANT, 'soft' => true),
        ...
        // RPR-W09 (2026-08-26): دورةُ التوريدِ من الطلبِ إلى الإقفال.
        ...
        'proc_delivery_event' => array('type' => self::T_TENANT, 'soft' => false),
        'proc_hazmat_control' => array('type' => self::T_TENANT, 'soft' => false),
        'proc_invoice_match' => array('type' => self::T_TENANT, 'soft' => false),
        'proc_issue_request' => array('type' => self::T_TENANT, 'soft' => true),
        'proc_issue_request_line' => array('type' => self::T_TENANT, 'soft' => false),
        'proc_item_track_rule' => array('type' => self::T_TENANT, 'soft' => false),
        'proc_offer' => array('type' => self::T_TENANT, 'soft' => false),
        'proc_offer_line' => array('type' => self::T_TENANT, 'soft' => false),
        'proc_package' => array('type' => self::T_TENANT, 'soft' => true),
        'proc_package_member' => array('type' => self::T_TENANT, 'soft' => false),
        'proc_po_amendment' => array('type' => self::T_TENANT, 'soft' => false),
        'proc_rfq' => array('type' => self::T_TENANT, 'soft' => true),
        'proc_rfq_invite' => array('type' => self::T_TENANT, 'soft' => false),
        'proc_stock_state' => array('type' => self::T_TENANT, 'soft' => false),
        'proc_supplier_eval' => array('type' => self::T_TENANT, 'soft' => false),
        ...
        'acc_recognition_request' => array('type' => self::T_TENANT, 'soft' => false),
        'acc_invoice_line' => array('type' => self::T_TENANT, 'soft' => false),
        'acc_supplier_accrual_line' => array('type' => self::T_TENANT, 'soft' => false),
        'acc_credit_limit' => array('type' => self::T_TENANT, 'soft' => false),
        'acc_period_adjustment' => array('type' => self::T_TENANT, 'soft' => false),
        'acc_account_recon' => array('type' => self::T_TENANT, 'soft' => false),
        'acc_account_recon_line' => array('type' => self::T_TENANT, 'soft' => false),
        'acc_trial_balance_run' => array('type' => self::T_TENANT, 'soft' => false),
        'acc_trial_balance_line' => array('type' => self::T_TENANT, 'soft' => false),
        'acc_period_reopen_request' => array('type' => self::T_TENANT, 'soft' => false),
        'tre_cash_box' => array('type' => self::T_TENANT, 'soft' => false),
        'tre_cash_move' => array('type' => self::T_TENANT, 'soft' => false),
        'tre_transfer' => array('type' => self::T_TENANT, 'soft' => false),
        'tre_fx_deal' => array('type' => self::T_TENANT, 'soft' => false),
        'tre_instrument' => array('type' => self::T_TENANT, 'soft' => false),
        'tre_guarantee' => array('type' => self::T_TENANT, 'soft' => false),
        'tre_recon_difference' => array('type' => self::T_TENANT, 'soft' => false),
        'tre_petty_custody' => array('type' => self::T_TENANT, 'soft' => false),
        ...
        'gov_ladder_actor_roles' => array('type' => self::T_GLOBAL, 'soft' => false),
        ...
        /* ◆ جداولُ السياسةِ تُكتب من **منفذٍ واحدٍ محروس** (`PolicyWriteService`)
             بنصِّ PERM-01-DEC §0-3، والمنفذُ يكتب بالبوّابةِ لا باستعلامٍ خامّ.
             وكلُّها تحمل `company_id` فهي وقائعُ مستأجِرٍ لا سياسةٌ عامّة. */
        /* ⛔ **والتصنيفُ بالواقعِ المقيسِ لا بالمعنى المرتجى**: قِيست الصفوفُ
             فإذا **كلُّ قوالبِ السياسةِ الـ204 بـ`company_id = 0`**، و**كلُّ
             المنحِ النافذةِ الخمسِ والسبعين بـ`company_id = 0`** أيضًا (والمنحُ
             الموسومةُ بالشركة 4 عددُها 76 وكلُّها **مسحوبة**). فتصنيفُهما
             مستأجِرًا يجعل البوّابةَ **لا ترى منحةً نافذةً واحدة** — فيمرُّ
             إسنادٌ ثانٍ لمن له قالبٌ ويقع اتّحادُ قالبَين الممنوعُ في §9.
             وهذا وصفُ ما هو، لا إقرارٌ بأنّه الصواب: عمودُ النطاقِ في هذين
             السجلَّين **غيرُ مستعمَل**، وتسويتُه قرارُ مالكٍ لا أثرٌ جانبيّ. */
        /* ◆ **والمنحُ `managed`**: سجلٌّ عامٌّ **يديره التطبيقُ** عبرَ المنفذِ
             المحروسِ وحدَه (`PolicyWriteService`) بحوكمةِ الشاشةِ والتجميد —
