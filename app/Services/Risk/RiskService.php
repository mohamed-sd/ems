...
class RiskService
{
    ...
    public static function createRisk(\mysqli $db, $companyId, array $d, $userId, $forceDuplicate = false)
    {
        ...
        /* ══ INJ-0109 · «المستندُ المنتَج: خطرٌ مسجَّلٌ **بمالكٍ ووحدة**» ══════════
             كان الفرزُ يمرّر `owner_unit_id = null` فيُكتب الخطرُ بلا وحدةٍ مالكة،
             وحارسُ النطاقِ يطابق بالمساواة (`rr.owner_unit_id = {$u}`) — و**NULL
             لا يساوي شيئًا**: فالخطرُ لا يظهر في سجلِّ إدارتِه أبدًا، ولا يُعرف
             عند مَن توقّف.
           ◆ والرفضُ **في الخدمةِ لا في النموذج** (CS-05): نموذجٌ يُصلَح يُلتفُّ
             عليه بطلبٍ مصنوع، والخدمةُ بابٌ واحدٌ لكلِّ الكاتبين. */
        /* والوجودُ في الهيكلِ يفحصه حارسُ INJ-0577 أدناه — فلا تعريفان لفحصٍ واحد.
