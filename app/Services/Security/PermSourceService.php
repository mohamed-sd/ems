...
class PermSourceService
{
    ...
    public static function phaseReport(\mysqli $conn)
    {
        ...
        return array(
            ...
            'gate_to_flip' => 'صفر فرق 14 يومًا متصلة + توقيع مدير الصلاحيات — والحد صفر لا نسبة',
            'rollback' => 'قلب العلم عكسًا في دقائق بلا هجرة بيانات — وأي منع خاطئ يعطل عملًا يُقلب فورًا ويُحقَّق',
        );
    }
}
