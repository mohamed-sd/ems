...
include __DIR__ . '/../includes/page_header.php'; ?>
    ...
    <div class="card"><div class="card-header"><h5><i class="fa fa-clipboard-list"></i> انتقال الملكية والخروج بحقول الورقة</h5></div>
    <div class="card-body"><div class="table-container">
        ...
        $GUIDE_COLS = array(
            ...
            'FCON_ID' => 'g382',
            'Financier_ID' => 'g383',
            'كود العين/الآلية' => 'g384',
            'ترتيب الانتقال' => 'g385',
            'من (المالك السابق)' => 'g386',
            'إلى (المالك الجديد)' => 'g387',
            'الحصة %' => 'g388',
            'التاريخ' => 'g389',
            'قيمة البيع' => 'g390',
            'العملة' => 'g391',
        ...
        $D = array();
        $__gridRows = ems_w14_guide_rows('fin_asset_disposal');
        echo ems_w14_grid('emsList_fin_disposal', $GUIDE_COLS, $__gridRows, $D, 'لا انتقال ملكية مسجل بعد'); /* /GUIDE_COLS */ ?>
    </div></div></div>
    <?php 
