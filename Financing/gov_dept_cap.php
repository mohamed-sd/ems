...
if (function_exists('ems_states_bundle')) {
    echo ems_states_bundle('لا قياسات فصل واجبات معلنة لحوكمة التمويل والملكية',
                           'تقاس القياسات على أقساط التمويل وروابط الملكية الحية — وما لم يقس يعلن ولا يلفق');
}
